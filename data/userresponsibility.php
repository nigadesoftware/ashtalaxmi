        ...
        <article class="w3-container">
          ...
          <section>
                        ...
                        if (isset($row['misuserresponsibilityid'])) 
                        {
                            ...
                            echo '</tr>';
                            $query ="select * from misuser m where m.misuseractive=1 and (miscustomerid=".$_SESSION['factorycode']." or miscustomerid=0) and m.misuserid=".$userid_de." order by misusername";
                            echo '<tr>';
                            echo '<td>';
                        ...
                        else
                        {
                            ...
                            $query ="select * from misuser m where m.misuseractive=1 and (miscustomerid = 0 or miscustomerid=".$_SESSION['factorycode'].") and m.misuserid=".$userid_de." order by misusername";
                            echo '<tr>';
                            echo '<td>';
                            echo '<select name="misuserid" style="height:35px;font-size:14px;">';
                            $result1=mysqli_query($connection, $query);
