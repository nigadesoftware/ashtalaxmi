<?php
	...
	$query = "insert into misuserresponsibility(misuserid,misresponsibilityid,misfactoryid,misactive,cruserid,crdatetime,misuserresponsibilityid) values ($misuserid,$misresponsibilityid,".$_SESSION['factorycode'].",1,".$_SESSION["usersid"].",'".currentdatetime()."',(select ifnull(max(misuserresponsibilityid),0)+1 from misuserresponsibility m where misuserresponsibilityid<=1000000))";
