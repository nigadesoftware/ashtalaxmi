<?php
    ...
    function isadmin($usrid)
    {
        ...
        $query = "SELECT misactive FROM misuserresponsibility r where r.misactive=1 and (misresponsibilityid=785236954125917 or misresponsibilityid=621478512368915) and misuserid=".$usrid." and (misfactoryid=".$_SESSION['factorycode']." and misfactoryid=0)";                          
        mysqli_query($connection,'SET NAMES UTF8');
        $result = mysqli_query($connection,$query);
        if ($row = @mysqli_fetch_assoc($result))
        {
