        ...
        <nav "w3-container">
            <ul >
                <?php
                    ...
                    echo '<a href="../mis/entitymenu.php">Entity Menu</br></a><a href="../op_view/monthlyledger_selection.php?accountcode='.$accountcode_en.'">Monthly Ledger View</br></a><a href="../op_view/dailyledger_selection.php?accountcode='.$accountcode_en.'&monthcode='.$monthcode_en.'&date='.$date_en.'">Daily Ledger View</a><a style="color:#f48" class="navbar" href="../sqlproc/logout.php">Log Out</a>';
                ?>
            </ul>
        </nav>
        <article "w3-container">
            ...
            ?>
                ...
                <?php
                    ...
                    $accounthead1->fetch();
                    $openingbalance=$accounthead1->openingbalance($date_de);
                    $closingbalance=$accounthead1->closingbalance($date_de);
                    echo '<thead>';  
                    if ($_SESSION['lng'] == "English")
                        {
                            echo '<tr style="font-family:siddhanta;font-size:18px">'; 
                            echo '<th colspan="6" style="text-align:center">Account '.$accounthead1->accountnameeng.' </th>';
                            echo '</tr>';
                             echo '<tr style="font-family:siddhanta;font-size:18px">'; 
                            echo '<th colspan="6" style="text-align:center">Ledger Date '.$date.' </th>';        
                            echo '</tr>';
                        }
                    else
                        {         
                            echo '<tr style="font-family:siddhanta;font-size:18px">'; 
                            echo '<th colspan="6" style="text-align:center">लेजर '.$accounthead1->accountnameuni.' </th>';
                            echo '</tr>';
                            echo '<tr style="font-family:siddhanta;font-size:16px">'; 
                            echo '<th colspan="6" style="text-align:center">लेजर खतावणी दिनांक '.$date.' </th>';
                            echo '</tr>';
                        }
                    echo '<thead>';
                ?>
