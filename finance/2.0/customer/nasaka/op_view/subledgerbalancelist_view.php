<?php
    ...
    if (isset($_POST['accountcode']))
    {
        ...
        $accountcode_en=fnEncrypt($_POST['accountcode']);
    }
            ...
            ?>
                ...
                <?php
                    ...
                    if ($_SESSION['lng'] == "English")
                    {
                        ...
                        echo '<th colspan="8" style="text-align:center">SubLedger Balance List</th>';
                        echo '</tr>';
                        echo '<tr style="font-family:siddhanta;font-size:18px">'; 
                        echo '<th colspan="8" style="text-align:center">'.$accounthead1->subledgernameeng.'</th>';
                        echo '</tr>';
                        echo '<tr style="font-family:siddhanta;font-size:18px">'; 
                    ...
                    {         
                        echo '<tr style="font-family:siddhanta;font-size:18px">'; 
                        echo '<th colspan="8" style="text-align:center">सबखतावणी शिल्लक यादी पत्रक</th>';
                        echo '</tr>';
                        echo '<tr style="font-family:siddhanta;font-size:18px">'; 
                        echo '<th colspan="8" style="text-align:center">'.$accounthead1->subledgernameuni.'</th>';
                        echo '</tr>';
                ...
                else
                {
                    ...
                    echo '<thead>';   
                    echo '<tr style="font-family:siddhanta;font-size:16px"> '; 
                    echo '<th colspan="2" style="text-align:center">सबखतावणी तपशील</th>';  
                ...
                $query = "
                select accountcode,subledgercode,subledgernameuni,subledgernameeng,
                ...
                from(
                select t.accountcode,t.subledgercode,h.subledgernameuni,h.subledgernameeng,sum(openingbalance) as openingbalance,sum(credit) as credit,sum(debit) as debit,sum(closingbalance) as closingbalance
                from (
                ...
                group by accountcode,subledgercode)t,accountsubledger h
                where t.accountcode=h.accountcode
                and t.subledgercode=h.subledgercode
                and h.accountcode=".$accountcode."
                group by t.accountcode,t.subledgercode,h.subledgernameuni,h.subledgernameeng)
                ...
                while ($row = oci_fetch_array($result,OCI_ASSOC+OCI_RETURN_NULLS))
                {
                        ...
                        if ($_SESSION['lng'] == "English")
                        {
                            echo '<td style="font-family:siddhanta;font-size:14px;">'.$row['SUBLEDGERNAMEENG'].'</td>';
                        }
                        else
                        {
                            echo '<td style="font-family:siddhanta;font-size:14px;">'.$row['SUBLEDGERNAMEUNI'].'</td>';
                        }
