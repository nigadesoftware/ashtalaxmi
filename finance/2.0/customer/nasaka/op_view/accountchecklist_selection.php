<?php
    ...
    $typecode_de = fnDecrypt($_GET['typecode']);
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <article class="w3-container">
            <?php
                ...
                if ($typecode_de == 1)
                {
                    echo '<form method="post" action="../op_controller/groupwiseaccount_action.php">';
                }
                elseif ($typecode_de == 2)
                {
                    echo '<form method="post" action="../op_controller/schedulewiseaccount_action.php">';
                }
                echo '<table border="0" >';
