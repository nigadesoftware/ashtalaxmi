...
function invoicedate(&$connection,$transactionid)
    ...
    function isdateinperiod_financialyear($dt)
    {
        $dt1=substr($_SESSION['yearperiodcode'],0,4).'-04-01';
        $dt2=substr($_SESSION['yearperiodcode'],4,4).'-03-31';
        $dt3=DateTime::createFromFormat('d-M-Y',$dt)->format('Y-m-d');
