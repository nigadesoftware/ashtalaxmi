		...
		<article class="w3-container">
			<section>
					<?php
						...
						$query = "select t.legalentitycode,t.legalentitynameeng,t.legalentitynameuni from legalentity t";
						...
						echo '</tr>';
						$connection=swapp_connection();
						$query = "select t.legalentitycode,t.legalentitynameeng,t.legalentitynameuni from legalentity t order by t.legalentitycode";
						$result = oci_parse($connection, $query);
						$r = oci_execute($result);
						$sr=0;
						...
						if ($sr==1)
						{
							header("Location: ../mis/selectfinancialyear.php?legalentitycode='.$legalentitycode_en.'");
						}
					?>
			</section>
		</article>
