<?php
    ...
    $moduleid = new crypto;
    $mismoduleid_de = $moduleid->Decrypt($_GET['mismoduleid']);
    ...
    <body>
        ...
        <nav "w3-container">
            <ul class="navbar">
                ...
                <li><a class="servicebar" href="../mis/changepassword.php">Change Password</a>
            </ul>
        </nav>
            ...
            <section>
                <form method="post" action="../sqlproc/selectedresponsibility.php">
                    <table style="border=1px solid black; border-radius:10px; padding:0px; padding-top:6px;margin: 0px;" align="left" width="200px">
                        ...
                        echo '</tr>';
                        $query ="select * from misuserresponsibility m,misresponsibility r,mismoduleresponsibility b where m.misactive=1 and r.misactive=1 and b.active=1 and m.misresponsibilityid=r.misresponsibilityid and r.misresponsibilityid=b.misresponsibilityid and b.mismoduleid=".$mismoduleid_de." and misuserid=".$_SESSION["usersid"]." and (misfactoryid=0 or misfactoryid=".$_SESSION["factorycode"].') order by r.misresponsibilityname';
                        echo '<tr>';
                        echo '<td>';
                        //$defaultresponsibilityid = getdefaultresponsibilityid($connection);
                        $defaultresponsibilityid = $_SESSION['defresponsibilityid'];
                        if ($defaultresponsibilityid!=0 and $_SESSION['responsibilitycode'] !='')
                        {
                            $responsibilityid_en = fnEncrypt($defaultresponsibilityid);
                            header('location: ../sqlproc/selectedresponsibility.php?responsibility_code='.$responsibilityid_en);
                            exit;
                        }
                        ...
                        echo '<input type="checkbox" name="lng" id="lng" value="Yes" checked/>';
                        echo '</tr>';
                        ?>
                        <tr>
                            <td></td>
