<?php
include_once("../api_base/operationmode.php");
class swappform
{
	...
	{
		if ($this->beingvalidation==true and $this->invalidid==0)
		{
			if ($data == '')
			{
				$this->invalidid=-2;
...
protected function iifnull($data,$isnumber=true)
{
...
protected function nvl($data,$value)
{
	if ($this->isnvl($data) == true)
	{
		return $value;
	}
	else
