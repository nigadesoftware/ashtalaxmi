            ...
            <?php
                ...
                while ($row1 = oci_fetch_array($result1,OCI_ASSOC+OCI_RETURN_NULLS))
                {
                    ...
                    if($row1['INPUTCONTROLTYPECODE']==1)
                    {
                        ...
                        {
                            echo '<td><input readonly="readonly" tabindex="-1" type="text" autocomplete="off" style="font-size:12pt;height:30px" name="'.$row1['REPORTPARAMETERNAME_ENG'].'" id="'.$row1['REPORTPARAMETERNAME_ENG'].'" value="'.$_SESSION['yearperiodcode'].'"></td>';
                        }
                        if ($row1['REPORTPARAMETERCODE']==13 or $row1['REPORTPARAMETERCODE']==14)
                        {
                            echo '<td><input type="date" autocomplete="off" style="font-size:12pt;height:30px" name="'.$row1['REPORTPARAMETERNAME_ENG'].'" id="'.$row1['REPORTPARAMETERNAME_ENG'].'" ></td>';
                        }
                        else 
                        {
                ...
                {
                    echo '<tr>';
                    echo '<td><input type="checkbox" id="exportcsvfile" name="exportcsvfile" value="1">Export Kotak CSV File</td>';
                    echo '<td><input type="checkbox" id="exportcsvfile" name="exportcsvfile" value="2">Export Above2lac CSV File</td>';
                    echo '<td><input type="checkbox" id="exportcsvfile" name="exportcsvfile" value="3">Export Below2lac CSV File</td>';
                    echo '</tr>';
                    echo '<tr>';
                }
                elseif ($reportcode_de==83 or $reportcode_de==114 or $reportcode_de==160)
                {
                    echo '<tr>';
                    echo '<td><input type="checkbox" id="exportcsvfile" name="exportcsvfile" value="1" >Export Excel CSV File</td>';
                    echo '</tr>';
                    echo '<tr>';
                }
