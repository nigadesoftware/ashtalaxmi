...
{	
	...
	function pageheader()
    {
        ...
        //textbox($data,$width,$col,$datatype='',$alighment='',$languagecode='',$fontname='',$fontsize='',$newline='',$cangrow='',$currencysymbol='')  
        $this->textbox('DateWise and Indentwise Cane Harvesting Material Status (Season- '.substr($this->season,0,4).'-'.substr($this->season,6,2).')',290,10,'S','C',1,'verdana',11,'','','','B');
       ...
       // $this->textbox('7001',$this->w,$this->x,'S','C',1,'verdana',11,'','','','B');
        ...
        $this->setfieldwidth(35);
        $this->textbox('Jugad/Tyre No',$this->w,$this->x,'S','C',1,'verdana',11,'','','','B');
        $this->vline($this->liney-8,$this->liney+7,$this->x+$this->w);

       

        $this->hline(10,290,$this->liney+7,'C'); 
        $this->newrow();
    }
    ...
    function group()
    {
       ...
       /*  if ($this->mainstorecode!=0)
        ...
        group by newdate,contractorcode,contractornameeng
        ,issudate,issuenumber
        order by newdate asc --,issuenumber asc
    ...
    function detail_1(&$group_row_1)
    {
        ...
        $this->textbox( $this->sr_no,$this->w,$this->x,'S','c',1,'verdana',10);
        ...
        $this->setfieldwidth(20);        
        $this->textbox($group_row_1['ISSUENUMBER'],$this->w,$this->x,'S','R',1,'verdana',10);
        $this->vline($this->liney-1,$this->liney+$ht,$this->x+$this->w);
        ...
        $this->setfieldwidth(15);
        $this->textbox($group_row_1['KNIFE'],$this->w,$this->x,'S','R',1,'verdana',10);        
        $this->vline($this->liney-1,$this->liney+7,$this->x+$this->w);

        $this->setfieldwidth(15);
        $this->textbox($group_row_1['BAMBOO'],$this->w,$this->x,'S','R',1,'verdana',10);        
        $this->vline($this->liney-1,$this->liney+7,$this->x+$this->w);

        $this->setfieldwidth(15);
        $this->textbox($group_row_1['TENT'],$this->w,$this->x,'S','R',1,'verdana',10);        
        $this->vline($this->liney-1,$this->liney+7,$this->x+$this->w);

        $this->setfieldwidth(15);
        $this->textbox($group_row_1['WIRE_ROPE_2421'],$this->w,$this->x,'S','R',1,'verdana',10);        
        $this->vline($this->liney-1,$this->liney+7,$this->x+$this->w);

        $this->setfieldwidth(15);
        $this->textbox($group_row_1['WIRE_ROPE_2424'],$this->w,$this->x,'S','R',1,'verdana',10);        
        $this->vline($this->liney-1,$this->liney+7,$this->x+$this->w);

        $this->setfieldwidth(15);
        $this->textbox($group_row_1['WIRE_ROPE_2828'],$this->w,$this->x,'S','R',1,'verdana',10);        
        $this->vline($this->liney-1,$this->liney+7,$this->x+$this->w);

        $this->setfieldwidth(15);
        $this->textbox($group_row_1['STAND'],$this->w,$this->x,'S','R',1,'verdana',10);        
        $this->vline($this->liney-1,$this->liney+7,$this->x+$this->w);

        $this->setfieldwidth(15);
        $this->textbox($group_row_1['BULLOCKKART'],$this->w,$this->x,'S','R',1,'verdana',10);        
        $this->vline($this->liney-1,$this->liney+7,$this->x+$this->w);

        $this->setfieldwidth(15);
        $this->textbox($group_row_1['TRACTORCART'],$this->w,$this->x,'S','R',1,'verdana',10);        
        $this->vline($this->liney-1,$this->liney+7,$this->x+$this->w);
