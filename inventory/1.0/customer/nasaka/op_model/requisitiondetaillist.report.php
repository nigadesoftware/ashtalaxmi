...
class requisitiondetaillist extends reportbox
{	
	...
	function pageheader()
    {
        ...
        //textbox($data,$width,$col,$datatype='',$alighment='',$languagecode='',$fontname='',$fontsize='',$newline='',$cangrow='',$currencysymbol='')  
        $this->newrow(7);
        $this->textbox('व्यवहार क्रमांक',170,10,'S','C',1,'siddhanta',13);
        $this->newrow(2);
        ...
        $this->setfieldwidth(25);
        $this->textbox('मागणी संख्या',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
    ...
    function group()
    {
        ...
        $group_query_1 ="select * from requisitiondetail order by transactionnumber"; 
