...
class goodsreceiptitemdetaillist extends reportbox
{	
	...
	function pageheader()
    {
        ...
        //textbox($data,$width,$col,$datatype='',$alighment='',$languagecode='',$fontname='',$fontsize='',$newline='',$cangrow='',$currencysymbol='')  
        $this->newrow(10);
        $this->setfieldwidth(70,75);
        $this->textbox('खरेदी आवक आयटम चेंक लिस्ट',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->newrow(10);
    ...
    function group()
    {
        ...
        $group_query_1 ="select * from goodsreceiptitemdetail order by transactionnumber,serialnumber"; 
