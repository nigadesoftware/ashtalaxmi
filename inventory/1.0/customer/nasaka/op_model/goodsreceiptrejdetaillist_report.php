...
class goodsreceiptrejdetaillist extends reportbox
{	
	...
	function pageheader()
    {
        ...
        $this->textbox('वस्तू पावती नकार तपशील चेंक लिस्ट',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->newrow(10);
        ...
        $this->textbox('नाकारलेली संख्या ',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
    ...
    function group()
    {
        ...
        $group_query_1 ="select * from goodsreceiptrejdetail order by transactionnumber,serialnumber"; 
    ...
    function detail_1(&$group_row_1)
    {
        ...
        $this->setfieldwidth(35);
        $this->textbox($group_row_1['REJECTEDQUANTITY'],$this->w,$this->x,'S','R',1,'SakalMarathiNormal922',10);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
