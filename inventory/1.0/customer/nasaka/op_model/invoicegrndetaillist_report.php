...
class invoicegrndetaillist extends reportbox
{	
	...
	function pageheader()
    {
        ...
        $this->textbox('बील जी आर एन तपशील चेंक लिस्ट',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->newrow(10);
        ...
        $this->textbox('जी आर एन व्यवहार क्रमांक',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
    ...
    function group()
    {
        ...
        $group_query_1 ="select * from invoicegrndetail order by transactionnumber,serialnumber"; 
    ...
    function detail_1(&$group_row_1)
    {
        ...
        $this->setfieldwidth(55);
        $this->textbox($group_row_1['GRNTRANSACTIONNUMBER'],$this->w,$this->x,'S','L',1,'SakalMarathiNormal922',11);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
