...
class enquiryitemdetaillist extends reportbox
{	
	...
	function pageheader()
    {
        ...
        $this->textbox('चौकशी आयटम चेंक लिस्ट',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->newrow(10);
        $this->hline(10,265,$this->liney+6,'C');
        $this->newrow(7);
        ...
        $this->textbox('चौकशीचे प्रमाण',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);

        $this->setfieldwidth(40);
        $this->textbox('आयटम तपशील',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
    ...
    function group()
    {
        ...
        $group_query_1 ="select * from enquiryitemdetail order by transactionnumber"; 
        ...
        while ($group_row_1 = oci_fetch_array($group_result_1,OCI_BOTH+OCI_ASSOC+OCI_RETURN_NULLS))
        {
            ...
            $this->hline(10,265,$this->liney,'D'); 
    ...
    function detail_1(&$group_row_1)
    {
        ...
        $this->setfieldwidth(50);
        $this->textbox($group_row_1['ENQUIRYQUANTITY'],$this->w,$this->x,'S','R',1,'SakalMarathiNormal922',10);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);

        $this->setfieldwidth(40);
        $this->textbox($group_row_1['ITEMSPECIFICATION'],$this->w,$this->x,'S','R',1,'SakalMarathiNormal922',10);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
        ...
        {
            $this->newrow();
            $this->hline(10,265,$this->liney-2,'C'); 
            $this->newpage(True);
        }   
        else
        {
