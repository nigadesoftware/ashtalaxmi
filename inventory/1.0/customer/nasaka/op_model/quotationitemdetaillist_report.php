...
class quotationitemdetaillist extends reportbox
{	
	...
	function pageheader()
    {
        ...
        $this->textbox('कोटेशन आयटम चेंक लिस्ट',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->newrow(10);
        $this->hline(10,115,$this->liney+6,'C');
        $this->newrow(7);
        ...
        $this->setfieldwidth(25);
        $this->textbox('कोटेशन रेट',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
    ...
    function group()
    {
        ...
        $group_query_1 ="select * from quotationitemdetail order by transactionnumber,serialnumber"; 
        ...
        while ($group_row_1 = oci_fetch_array($group_result_1,OCI_BOTH+OCI_ASSOC+OCI_RETURN_NULLS))
        {
            ...
            $this->hline(10,115,$this->liney,'D'); 
    ...
    function detail_1(&$group_row_1)
    {
        ...
        $this->setfieldwidth(25);
        $this->textbox($group_row_1['QUOTATIONRATE'],$this->w,$this->x,'S','R',1,'SakalMarathiNormal922',10);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);

        if ($this->isnewpage(15))
        {
            $this->newrow();
            $this->hline(10,115,$this->liney-2,'C'); 
            $this->newpage(True);
        }   
        else
        {
