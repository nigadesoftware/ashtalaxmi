	...
	class MYPDF extends TCPDF 
    {
		...
		public function Header() {
			...
			*/// Set font
			...
			// Title
			//$this->Cell(0, 15, 'Nasik Sahakari Sakhar Karkhana Ltd.', 0, false, 'C', 0, '', 0, false, 'M', 'M');
          //  $this->SetFont('siddhanta', 'B', 12);
          //  $this->multicell(0,15,'Janardhan Swami Nagar, Palase, Tal-Dist-Nasik',0,'C',false,1,0,10,true,0,false,true,10);
