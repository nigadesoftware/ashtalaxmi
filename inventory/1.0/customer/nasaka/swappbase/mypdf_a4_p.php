	...
	class MYPDF extends TCPDF 
    {
		...
		public function Header() {
			...
			*/
			...
			$this->multicell(0,15,'  Ashtalaxmi Sugar Ethanol and Energy Limited',0,'C',false,1,0,4,true,0,false,true,10);
			$this->SetFont('verdana', 'B', 11);
			$this->multicell(0,15,'Nashik Sahakari Sakhar Karkhana Limited',0,'C',false,1,0,10,true,0,false,true,10);
			$this->SetFont('verdana', 'B', 10);
            //$this->Cell(0, 15, 'तालुका - नेवासा, जिल्हा - अहमदनगर', 0, false, 'C', 0, '', 0, false, 'M', 'M');
            $this->multicell(0,15,'  Sant Janardan Swami Nagar, Palase, Tal-Dist-Nasik Pin-422101',0,'C',false,1,0,15,true,0,false,true,10);
		}
