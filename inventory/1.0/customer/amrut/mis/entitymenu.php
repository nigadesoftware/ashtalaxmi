				...
				<?php
					...
					while ($row1 = oci_fetch_array($result,OCI_ASSOC+OCI_RETURN_NULLS))
					{
						...
						$query1 = "select r.parametername,r.parametervalue
							from nst_amrut_db.form t
							,nst_amrut_db.formparameterdetail r
							where t.formcode=r.formcode 
							and t.moduleid=325417849 
					...
					if ($_SESSION["responsibilitycode"] == 123981247 or $_SESSION["responsibilitycode"] == 123981564)
					{
					...
					$query = "select t.reportcode
							,t.reportname_eng
							,t.reportname_uni
							from nst_amrut_db.report t
							,nst_amrut_db.reportresponsibilitydetail r
