<?php
    ...
    if (isset($_SESSION['usersname']))
    {
        ...
        echo '<div><img src="../img/nigadesoftwaretechnologies_logo.png" width="100px" height="33px"></div>';
        echo '<div><img src="../img/erp.png" width="49px" height="26px"></div>';
        echo '<div><img src="../img/agriculture.png" width="120px" height="31px"></div>';
        echo '<div><img src="../img/Twentyoneu1.jpg" width="35px" height="35px"></div>';
        ...
        if (isset($_SESSION['financialyear']))
        {
            if ($_SESSION['financialyear']!='0')
            {
                ...
                echo '<tr style="font-size:14px">';
                echo '<td><label>Season Year : </label></td>';
