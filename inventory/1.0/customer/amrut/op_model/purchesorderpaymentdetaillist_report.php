...
class purchesorderpaymentdetaillist extends reportbox
{	
	...
	function pageheader()
    {
        ...
        $this->textbox('ऑर्डर पेमेंटची पूर्तता चेंक लिस्ट',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->newrow(10);
        $this->hline(10,190,$this->liney+6,'C');
        $this->newrow(7);
        ...
        $this->textbox('अ‍ॅडव्हान्स क्रमांक',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);

        $this->setfieldwidth(35);
        $this->textbox('अ‍ॅडव्हान्स भरणा',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);

        $this->setfieldwidth(40);
        $this->textbox('अ‍ॅडव्हान्स टर्म कोड',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
    ...
    function group()
    {
        ...
        $group_query_1 ="select * from purchesorderpaymentdetail order by transactionnumber"; 
        ...
        while ($group_row_1 = oci_fetch_array($group_result_1,OCI_BOTH+OCI_ASSOC+OCI_RETURN_NULLS))
        {
            ...
            $this->hline(10,190,$this->liney,'D'); 
    ...
    function detail_1(&$group_row_1)
    {
        ...
        $this->setfieldwidth(40);
        $this->textbox($group_row_1['ADVANCENUMBER'],$this->w,$this->x,'S','L',1,'SakalMarathiNormal922',11);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);

        $this->setfieldwidth(35);
        $this->textbox($group_row_1['ADVANCEPAYMENT'],$this->w,$this->x,'S','R',1,'SakalMarathiNormal922',10);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);

        $this->setfieldwidth(40);
        $this->textbox($group_row_1['ADVANCETERMCODE'],$this->w,$this->x,'S','R',1,'SakalMarathiNormal922',10);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
