...
class negotiationheaderlist extends reportbox
{	
	...
	function pageheader()
    {
        ...
        $this->textbox('वाटाघाटी चेंक लिस्ट',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->newrow(10);
        ...
        $this->textbox('वाटाघाटी तारीख',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
    ...
    function group()
    {
        ...
        $group_query_1 ="select * from negotiationheader order by transactionnumber"; 
    ...
    function detail_1(&$group_row_1)
    {
        ...
        $this->setfieldwidth(35);
        $this->textbox($group_row_1['NEGOTIATIONDATE'],$this->w,$this->x,'S','L',1,'SakalMarathiNormal922',11);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
        ...
        {
            $this->newrow();
            $this->hline(10,130,$this->liney-2,'C'); 
            $this->newpage(True);
        }   
        else
        {
