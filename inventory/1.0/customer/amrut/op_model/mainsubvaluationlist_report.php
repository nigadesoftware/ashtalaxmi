...
class mainsubvaluationlist extends reportbox
{	
    ...
    function group()
    {
        ...
        $frdt=DateTime::createFromFormat('d/m/Y',$this->fromdate)->format('d-M-Y');
        $todt=DateTime::createFromFormat('d/m/Y',$this->todate)->format('d-M-Y');
        $group_query_1 ="select mainstorecode,substorecode
        ,mainstorenameeng,substorenameeng
        ,sum(vopeningstock) vopeningstock,sum(vreceipt) vreceipt
        ,sum(vissue) vissue,sum(vclosingstock) vclosingstock
        ,sum(qopeningstock) qopeningstock,sum(qreceipt) qreceipt
        ,sum(vissue) qissue,sum(vclosingstock) qclosingstock
        from (select m.mainstorecode,s.substorecode
        ...
        and ".$cond." )
        group by mainstorecode,substorecode
        ,mainstorenameeng,substorenameeng
        order by mainstorecode,substorecode";
    ...
    {
        $y=$this->height($group_row_1['SUBSTORENAMEENG'],90);
        $y=$y+3;
        if ($y<6)
            $r=6;
        else
        ...
        $this->textbox($group_row_1['SUBSTORECODE'],$this->w,$this->x,'S','L',1,'verdana',9,'','Y');
        $this->vline($this->liney-1,$this->liney+$r,$this->x+$this->w);
        $this->setfieldwidth(90);
        $this->textbox($group_row_1['SUBSTORENAMEENG'].' '.$group_row_1['UNITNAMEENG'],$this->w,$this->x,'S','L',1,'verdana',9,'','Y');
        $this->vline($this->liney-1,$this->liney+$r,$this->x+$this->w);
 ...
 */
    ...
    { 
        ...
        $this->setfieldwidth(90);
        $this->textbox($group_row_1['MAINSTORENAMEENG'].' Main Store Total',$this->w,$this->x,'N','R',1,'verdana',8);
        $this->vline($this->liney-1,$this->liney+$r,$this->x+$this->w);

        $this->setfieldwidth(20);
        $this->textbox($this->mainstoresummary['VOPENINGSTOCK'],$this->w,$this->x,'N','R',1,'verdana',8);
        $this->vline($this->liney-1,$this->liney+$r,$this->x+$this->w);

        $this->setfieldwidth(20);
        $this->textbox($this->mainstoresummary['VRECEIPT'],$this->w,$this->x,'N','R',1,'verdana',8);
        $this->vline($this->liney-1,$this->liney+$r,$this->x+$this->w);

        $this->setfieldwidth(20);
        $this->textbox($this->mainstoresummary['VISSUE'],$this->w,$this->x,'N','R',1,'verdana',8);
        $this->vline($this->liney-1,$this->liney+$r,$this->x+$this->w);
        
        $this->setfieldwidth(20);
        $this->textbox($this->mainstoresummary['VCLOSINGSTOCK'],$this->w,$this->x,'N','R',1,'verdana',8);
        $this->vline($this->liney-1,$this->liney+$r,$this->x+$this->w);
    ...
    function reportfooter()
    {
        ...
        $this->setfieldwidth(90);
        $this->textbox('Grand Total',$this->w,$this->x,'N','R',1,'verdana',8);
        $this->vline($this->liney-1,$this->liney+$r,$this->x+$this->w);
