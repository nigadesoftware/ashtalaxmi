...
class issueitemdetaillist extends reportbox
{	
	...
	function pageheader()
    {
        ...
        $this->textbox('ईशु आयटम डीटेल चेंक लिस्ट',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->newrow(10);
    ...
    function group()
    {
        ...
        $group_query_1 ="select * from issueitemdetail order by transactionnumber,serialnumber"; 
    ...
    function detail_1(&$group_row_1)
    {
        ...
        $this->setfieldwidth(30);
        $this->textbox($group_row_1['JOBCODE'],$this->w,$this->x,'S','R',1,'SakalMarathiNormal922',10);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
