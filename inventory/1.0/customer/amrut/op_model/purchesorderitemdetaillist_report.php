...
class purchesorderitemdetaillist extends reportbox
{	
	...
	function pageheader()
    {
        ...
        //textbox($data,$width,$col,$datatype='',$alighment='',$languagecode='',$fontname='',$fontsize='',$newline='',$cangrow='',$currencysymbol='')  
        $this->newrow(10);
        $this->setfieldwidth(70,110);
        $this->textbox('खरेदी ऑर्डर आयटम तपशील चेंक लिस्ट',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->newrow(10);
    ...
    function group()
    {
        ...
        $group_query_1 ="select * from purchesorderitemdetail order by transactionnumber,serialnumber"; 
    ...
    function detail_1(&$group_row_1)
    {
        ...
        $this->setfieldwidth(30);
        $this->textbox($group_row_1['ITEMSPCIFICATION'],$this->w,$this->x,'S','R',1,'SakalMarathiNormal922',10);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
        ...
        $this->setfieldwidth(25);
        $this->textbox($group_row_1['AMOUNT'],$this->w,$this->x,'S','R',1,'SakalMarathiNormal922',10);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
