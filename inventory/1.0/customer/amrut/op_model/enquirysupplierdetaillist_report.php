...
class enquirysupplierdetaillist extends reportbox
{	
	...
	function pageheader()
    {
        ...
        $this->newrow(10);
        $this->hline(10,110,$this->liney+6,'C');
        $this->newrow(7);
    ...
    function group()
    {
        ...
        $group_query_1 ="select * from enquirysupplierdetail order by transactionnumber"; 
        ...
        while ($group_row_1 = oci_fetch_array($group_result_1,OCI_BOTH+OCI_ASSOC+OCI_RETURN_NULLS))
        {
            ...
            $this->hline(10,110,$this->liney,'D'); 
    ...
    function detail_1(&$group_row_1)
    {
        ...
        {
            $this->newrow();
            $this->hline(10,110,$this->liney-2,'C'); 
            $this->newpage(True);
        }   
        else
        {
