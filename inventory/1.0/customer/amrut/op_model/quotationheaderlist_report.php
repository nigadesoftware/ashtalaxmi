...
class quotationheaderlist extends reportbox
{	
	...
	function pageheader()
    {
        ...
        $this->textbox('चौकशी व्यवहार क्रमांक',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
        ...
        $this->setfieldwidth(30);
        $this->textbox('कोटेशन नंबर',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);

        $this->setfieldwidth(40);
        $this->textbox('कोटेशन तारीख',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
    ...
    function group()
    {
        ...
        $group_query_1 ="select h.*,e.employeenameuni,e.employeenameeng 
        from quotationheader h,employee e 
    ...
    function detail_1(&$group_row_1)
    {
        ...
        $this->setfieldwidth(55);
        $this->textbox($group_row_1['ENQTRANSACTIONNUMBER'],$this->w,$this->x,'S','L',1,'SakalMarathiNormal922',11);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
        ...
        $this->setfieldwidth(30);
        $this->textbox($group_row_1['QUOTATIONNUMBER'],$this->w,$this->x,'S','R',1,'SakalMarathiNormal922',10);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);

        $this->setfieldwidth(40);
        $this->textbox($group_row_1['QUOTATIONDATE'],$this->w,$this->x,'S','R',1,'SakalMarathiNormal922',10);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
