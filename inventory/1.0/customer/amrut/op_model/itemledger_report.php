...
{	
    ...
    function group()
    {
        ...
        $frdt=DateTime::createFromFormat('d/m/Y',$this->fromdate)->format('d-M-Y');
        $todt=DateTime::createFromFormat('d/m/Y',$this->todate)->format('d-M-Y');
        $group_query_1 ="select t.itemcode,i.itemnameeng,transdate,flag,narration,debitqty,creditqty
        from 
        (
            ...
            from issueheader ih,issueitemdetail id,nst_payroll.sectionmaster sm
    ...
    function detail_1(&$group_row_1)
    {
        ...
        $this->setfieldwidth(90);
        $y=$this->textbox($group_row_1['NARRATION'],$this->w,$this->x,'S','L',1,'verdana',11,'','Y');
        $this->vline($this->liney-1,$this->liney+$r,$this->x+$this->w);
