...
{	
    ...
    function group()
    {
        ...
        $group_query_1 ="select h.transactionnumber,h.goodsreceiptnoteprefixnumber,h.goodreceiptdate
        ,s.suppliercode,s.suppliernameeng,i.itemcode,i.itemnameeng,u.unitnameeng
        ,purchesorderfrefixnumber,purchesorderdate,d.quantity,d.acceptedquantity
        ,h.challannumber
        ,h.challandate
        ,h.gateinwardnumber
        ,h.gateinwarddate
        ...
        and h.transactionnumber=ph.transactionnumber(+)
    ...
    function groupheader_1(&$group_row_1)
    {
        ...
        $dt=DateTime::createFromFormat('d-M-Y',$group_row_1['GOODRECEIPTDATE'])->format('d/m/Y');
        else
        $dt='';
        ...
        $dt='';
        $this->textbox('Challan Date :'.$dt,$this->w,$this->x,'S','L',1,'verdana',10);
        $this->newrow(7);
        ...
        if ($group_row_1['GOODRECEIPTDATE']!='')
            ...
            $podt='';
        $this->setfieldwidth(60,130);
        $this->textbox('PO Date :'.$podt,$this->w,$this->x,'S','L',1,'verdana',10);
        $this->newrow(7);
        $this->setfieldwidth(60,10);
