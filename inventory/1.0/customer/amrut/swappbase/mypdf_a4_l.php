...
// Extend the TCPDF class to create custom Header and Footer
	class MYPDF extends TCPDF 
    {
		...
		public function Header() {
			...
			*/// Set font
			$image_file = K_PATH_IMAGES.'amrutsugarlogo.jpg';
			//$image_file = K_PATH_IMAGES.'Twentyoneu1.jpg';
			...
			$this->multicell(0,15,'Sahakarmaharshi Bhausaheb Thorat Sahakari Sakhar Karkhana ltd.',0,'C',false,1,0,4,true,0,false,true,10);
			$this->SetFont('siddhanta', 'B', 10);
            //$this->Cell(0, 15, 'तालुका - नेवासा, जिल्हा - अहमदनगर', 0, false, 'C', 0, '', 0, false, 'M', 'M');
            $this->multicell(0,15,'Amrutnagar Tal - Sangamner',0,'C',false,1,0,10,true,0,false,true,10);
		}
