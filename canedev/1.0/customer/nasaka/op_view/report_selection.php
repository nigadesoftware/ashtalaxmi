<?php
    ...
    require("../../../../../agriculture/1.0/customer/kadwa/ip_model/report_db_oracle.php");
    require("../../../../../agriculture/1.0/customer/kadwa/ip_model/reportparameterdetail_db_oracle.php");
    //
    ...
    <body>
        ...
        <article class="w3-container">
            <?php
                ...
                echo '<td><input class="button123" type="submit" name="btn" id="btn" value="Report" style="width:100px"></td>';;
                echo '</tr>';
                echo '</table>';
                echo '</form>';
            ?>
