	...
	<body>
			...
			<article class="w3-container">
				...
				<?php
					...
					elseif (in_array($_SESSION["responsibilitycode"],array(123981565,123981566,123981567,123981568,123981569,123981570,123457106)))
					{
						$goodscategorycode = '9';
						$goodscategorycode_en = fnEncrypt($goodscategorycode);
						$productname='Cane Development';
					}
					$tendercategorycode = tendercategry($connection,$goodscategorycode);
					if (in_array($_SESSION["responsibilitycode"],array(123981565,123981566)))
					{
						//echo "<p>";
					...
					else if (in_array($_SESSION["responsibilitycode"],array(123981567,123981568,123457106)))
					{
						//echo "<p>";
						//echo '<ul class="servicebar">';
							...
							elseif ($tendercategorycode==2)
							{
								...
								{
									$subgoodscategorycode_en=fnEncrypt('1');
									$salecategorycode_en=fnEncrypt('3');
									echo '<li><a class="servicebar" href="../ip_view/saleinvoiceheader.php?goodscategorycode='.$goodscategorycode_en.'&subgoodscategorycode='.$subgoodscategorycode_en.'&salecategorycode='.$salecategorycode_en.'">Cane Seed Purchase</a>';
									$salecategorycode_en=fnEncrypt('4');
									echo '<li><a class="servicebar" href="../ip_view/saleinvoiceheader.php?goodscategorycode='.$goodscategorycode_en.'&subgoodscategorycode='.$subgoodscategorycode_en.'&salecategorycode='.$salecategorycode_en.'">Cane Seed Sale</a>';
									$subgoodscategorycode_en=fnEncrypt('2');
									$salecategorycode_en=fnEncrypt('1');
									echo '<li><a class="servicebar" href="../ip_view/saleinvoiceheader.php?goodscategorycode='.$goodscategorycode_en.'&subgoodscategorycode='.$subgoodscategorycode_en.'&salecategorycode='.$salecategorycode_en.'">Fertiliser Credit Sale</a>';
									$salecategorycode_en=fnEncrypt('2');
									echo '<li><a class="servicebar" href="../ip_view/saleinvoiceheader.php?goodscategorycode='.$goodscategorycode_en.'&subgoodscategorycode='.$subgoodscategorycode_en.'&salecategorycode='.$salecategorycode_en.'">Fertiliser Cash Sale</a>';
									$salecategorycode_en=fnEncrypt('1');
									$subgoodscategorycode_en=fnEncrypt('3');
									echo '<li><a class="servicebar" href="../ip_view/saleinvoiceheader.php?goodscategorycode='.$goodscategorycode_en.'&subgoodscategorycode='.$subgoodscategorycode_en.'&salecategorycode='.$salecategorycode_en.'">Fertiliser Credit Sale</a>';
								}
								else
								{
									$subgoodscategorycode_en=fnEncrypt('1');
									$salecategorycode_en=fnEncrypt('3');
									echo '<li><a class="servicebar" href="../ip_view/saleinvoiceheader.php?goodscategorycode='.$goodscategorycode_en.'&subgoodscategorycode='.$subgoodscategorycode_en.'&salecategorycode='.$salecategorycode_en.'">ऊस बेणे बिल</a>';
									/* $salecategorycode_en=fnEncrypt('4');
									echo '<li><a class="servicebar" href="../ip_view/saleinvoiceheader.php?goodscategorycode='.$goodscategorycode_en.'&subgoodscategorycode='.$subgoodscategorycode_en.'&salecategorycode='.$salecategorycode_en.'">ऊस बेणे घेणारा</a>'; */
									$subgoodscategorycode_en=fnEncrypt('2');
									$salecategorycode_en=fnEncrypt('1');
									echo '<li><a class="servicebar" href="../ip_view/saleinvoiceheader.php?goodscategorycode='.$goodscategorycode_en.'&subgoodscategorycode='.$subgoodscategorycode_en.'&salecategorycode='.$salecategorycode_en.'">खत उधार विक्री</a>';
									$salecategorycode_en=fnEncrypt('2');
									echo '<li><a class="servicebar" href="../ip_view/saleinvoiceheader.php?goodscategorycode='.$goodscategorycode_en.'&subgoodscategorycode='.$subgoodscategorycode_en.'&salecategorycode='.$salecategorycode_en.'">खत रोख विक्री</a>';
									$salecategorycode_en=fnEncrypt('1');
									$subgoodscategorycode_en=fnEncrypt('3');
									echo '<li><a class="servicebar" href="../ip_view/saleinvoiceheader.php?goodscategorycode='.$goodscategorycode_en.'&subgoodscategorycode='.$subgoodscategorycode_en.'&salecategorycode='.$salecategorycode_en.'">ऊस रोप उधार विक्री</a>';
					...
					// Reports
					else if (in_array($_SESSION["responsibilitycode"],array(123470469,123473005,123480613,123480623,123480633,123480643)))
					{
						echo "<p>";
						echo '<ul class="servicebar">';
