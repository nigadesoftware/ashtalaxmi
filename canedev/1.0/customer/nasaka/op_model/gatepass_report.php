...
{	
	...
	function pageheader()
    {
        ...
        $this->textbox('मे.टन',30,130,'S','R',1,'siddhanta',10);
        $this->newrow();
        $this->hline(10,160,$this->liney);
    ...
    function detail()
    {
        ...
        while ($row = oci_fetch_array($result,OCI_ASSOC+OCI_RETURN_NULLS))
        {
            ...
            $this->textbox(number_format($row['SALEQUANTITY'],3),30,130,'S','R',1,'siddhanta',11);
            $this->newrow(5);
        }
        $this->hline(10,160,$this->liney);
        $this->newrow(2);
        ...
        $this->newrow();
        $this->textbox('Rajaramnagar, Tal-Dindori, Dist-Nashik',200,10,'S','C',1,'siddhanta',11);
        $this->newrow();
        $this->textbox('गेटपास '.$saleinvoiceheader1->goodscategorynameuni,180,10,'S','C',1,'siddhanta',13);
        $this->newrow(15);
        $this->textbox('गेटकिपर यांस',80,10,'S','L',1,'siddhanta',10);
