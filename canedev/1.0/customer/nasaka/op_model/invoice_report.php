...
{	
	...
	function pageheader()
    {
        ...
        $this->textbox('Address : '.$purchaser1->address,100,10,'S','L',1,'verdana',10);
        //$this->textbox('Address     : '.$broker1->address,80,70,'S','L',1,'verdana',10);
        $this->textbox('Address : '.$shiftto1->address,80,110,'S','L',1,'verdana',10);
        $this->newrow();
        ...
        $this->textbox('Qty',20,70,'S','R',1,'verdana',10);
        $this->textbox('Rate',15,90,'S','R',1,'verdana',10);
        $this->textbox('Taxable Value',30,110,'S','R',1,'verdana',10);
    ...
    function detail()
    {
        ...
        {
            $this->textbox('TCS Amount (1%)',50,140,'S','L',1,'verdana',9);
            $this->textbox($this->moneyFormatIndia($saleinvoiceheader1->tcsamount),30,170,'S','R',1,'verdana',9);
            $this->newrow();
            $this->hline(140,200,$this->liney+$limit);
        }
        if ($saleinvoiceheader1->advance!='')
        {
            $this->textbox('Advance',50,140,'S','L',1,'verdana',9);
            $this->textbox($this->moneyFormatIndia($saleinvoiceheader1->advance),30,170,'S','R',1,'verdana',9);
            $this->newrow();
        ...
        if ($saleinvoiceheader1->saleamount=='')
            $amount=$saleinvoiceheader1->grossamount;
        else
            $amount=$saleinvoiceheader1->saleamount;
        $this->textbox($this->moneyFormatIndia($amount),30,170,'S','R',1,'verdana',9);
        $this->textbox($this->moneyFormatIndia($amount),30,170,'S','R',1,'verdana',9);
        $this->newrow();
        $this->vline($this->liney,160,140);
        $this->vline($this->liney,167,175);
