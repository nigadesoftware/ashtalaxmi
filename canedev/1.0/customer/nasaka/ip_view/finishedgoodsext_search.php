<?php
    ...
    $subgoodscategorycode = $_GET['subgoodscategorycode'];
    ...
    elseif ($tendercategorycode==2)
    {
        if ($searchTerm == '**')
        {
            $query = "select b.finishedgoodscode
                ...
                and b.subcategorycode=".$subgoodscategorycode;
        }
        else
        {
            $query = "select b.finishedgoodscode
            ...
            or FINISHEDGOODSNAMEUNI like '%".$searchTerm."%'
            or to_char(b.FINISHEDGOODSCODE) like '".$searchTerm."')";
        }
    }
   ...
   while ($row = oci_fetch_array($result,OCI_ASSOC+OCI_RETURN_NULLS))
   {
       ...
       $query1 = "select t.taxcode,t.taxpercent,t.tcs
        from goodstaxrate t
