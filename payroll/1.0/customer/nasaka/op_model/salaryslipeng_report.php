<?php
    ...
    include_once("../swappbase/mypdf_a5_l_eng.php");
...
{	
    ...
    function group()
    {
        ...
        ." and p.monthcode = ".$this->monthcode
        ." and p.employeecategorycode=".$this->employeecategorycode
        ." and p.paymentcategorycode=".$this->paymentcategorycode;  
    ...
    { 
      $this->newpage(True);
      $this->newrow(10);
      $this->textbox('Pay Slip Month - '.$this->monthname." ".$_SESSION['yearperiodcode'],170,10,'S','C',1,'verdana',11);
      ...
      $this->textbox('Code and name: '.$group_row_1['EMPLOYEECODE'].' - '.$group_row_1['EMPLOYEENAMEENG'],$this->w,$this->x,'S','L',1,'verdana',10,'','','','B'); 
      $this->newrow();
      $this->vline($this->liney-4,$this->liney+7,$this->x);    
      $this->textbox('Type     : '.$group_row_1['EMPLOYEECATEGORYNAMEENG'],$this->w,$this->x,'S','L',1,'verdana',10); 
      ...
      $this->setfieldwidth(190,10);
      $this->vline($this->liney-4,$this->liney+7,$this->x);    
      $this->textbox('Section    : '.$group_row_1['SECTIONNAMEENG'].'    Dept :- '.$group_row_1['DEPARTMENTNAMEENG'],$this->w,$this->x,'S','L',1,'verdana',10); 
      $this->newrow();
      $this->vline($this->liney-4,$this->liney+7,$this->x);    
      $this->textbox('UAN    : '.$group_row_1['UAN'],$this->w,$this->x,'S','L',1,'verdana',10); 
      $this->vline($this->liney-25,$this->liney+7,$this->x+$this->W+190);  
      $this->newrow(-21);
      $this->setfieldwidth(60,110);
      $this->textbox('Present Days  : '.$group_row_1['PRESENTDAYS'],$this->w,$this->x,'S','L',1,'verdana',10,'','','',''); 
      $this->newrow();
      $this->textbox('Bank Name   :'.$group_row_1['BANKBRANCHNAME'],$this->w,$this->x,'S','L',1,'verdana',11,'','','',''); 
      $this->newrow();
      $this->textbox('Acc. No.:  '.$group_row_1['ACCOUNTNUMBER'],$this->w,$this->x,'S','L',1,'verdana',8,'','','',''); 
      $this->newrow(7);
      ...
      $this->textbox('Allowance',$this->w,$this->x,'S','C',1,'siddhanta',10,'','','','B'); 
      $this->vline($this->liney,$this->liney+7,$this->x+$this->w);
      $this->setfieldwidth(95);
      $this->vline($this->liney,$this->liney+7,$this->x+$this->w);
      $this->textbox('Deduction',$this->w,$this->x,'S','C',1,'siddhanta',10,'','','','B'); 
      $this->vline($this->liney,$this->liney+7,$this->x+$this->w);
      //$this->newrow();
      $this->hline(10,200,$this->liney+7,'C');
      ...
      and sa.allowanceamount>0
       ...
       while ($row = oci_fetch_array($result,oci_assoc+OCI_RETURN_NULLS))
       {
         ...
         $this->textbox($row['ALLOWANCECATEGORYNAMEENG'],$this->w,$this->x,'S','L',1,'siddhanta',10); 
         $this->setfieldwidth(20);
         $this->textbox($row['ALLOWANCEAMOUNT'],$this->w,$this->x,'S','R',1,'verdana',10); 
        ...
        while ($row = oci_fetch_array($result,oci_assoc+OCI_RETURN_NULLS))
        {
            ...
            $this->textbox($row['DEDUCTIONNAMEENG'],$this->w,$this->x,'S','L',1,'siddhanta',11); 
        ...
        $this->textbox('Total Allowance ',$this->w,$this->x,'S','R',1,'siddhanta',11); 
        $this->setfieldwidth(25);
        $this->textbox($group_row_1['GROSSSALARY'],$this->w,$this->x,'S','L',1,'verdana',11); 
        $this->setfieldwidth(25);
        $this->textbox('Total Deduction ',$this->w,$this->x,'S','R',1,'siddhanta',11); 
        $this->setfieldwidth(25);
        $this->textbox($group_row_1['GROSSDEDUCTION'],$this->w,$this->x,'S','L',1,'verdana',11); 
        $this->setfieldwidth(25);
        $this->textbox('Total NetPay',$this->w,$this->x,'S','R',1,'siddhanta',11); 
        $this->setfieldwidth(25);
        $this->textbox($group_row_1['NETSALARY'],$this->w,$this->x,'S','L',1,'verdana',11); 
        $this->hline(10,200,$this->liney+7,'C');
        $this->newrow(7);
        $this->vline($this->liney-2,$this->liney+7,10);
        //$this->vline($this->liney-1,$this->liney+5,105);
       ...
       // $this->textbox('NetPay in Word :'.NumberToWords($group_row_1['NETSALARY'],1),$this->w,$this->x,'S','L',1,'siddhanta',11); 
        $this->textbox('NetPay in Word : Rs '.getStringOfAmount(intval($group_row_1['NETSALARY']),0).' Only',180,50,'S','L',1,'siddhanta',9,'','Y');
        $this->hline(10,200,$this->liney+7,'C');
        $this->newrow(15);
        $this->setfieldwidth(50,25);
        $this->textbox('Labour Officer',$this->w,$this->x,'S','R',1,'siddhanta',11); 
        $this->setfieldwidth(100);
        $this->textbox('Genral Manager',$this->w,$this->x,'S','R',1,'siddhanta',11); 
