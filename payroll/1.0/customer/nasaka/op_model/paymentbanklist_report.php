   ...
   public $summary;
    ...
    { 
       ...
       // $this->textbox($this->ftransactionnumber['FARMERCOUNT'],175,10,'S','C',1,'siddhanta',13);
         ...
         $this->newrow(10);
        $this->textbox(' कर्मचारी बँक यादी माहे-'.$this->monthname.' '.$_SESSION['yearperiodcode'],150,10,'S','C',1,'siddhanta',13);
        ...
        $this->vline($this->liney-1,$this->liney+6,$this->x);
        $this->textbox('कोड',$this->w,$this->x,'S','C',1,'siddhanta',11);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
        ...
        $this->vline($this->liney-1,$this->liney+6,$this->x);
        $this->textbox('बँकेचे नाव',$this->w,$this->x,'S','C',1,'siddhanta',11);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);

        $this->setfieldwidth(30);
        $this->textbox('खाते नं',$this->w,$this->x,'S','C',1,'siddhanta',11);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);

        $this->setfieldwidth(30);
        $this->vline($this->liney-1,$this->liney+6,$this->x);
        $this->textbox('आई.एफ.एस.सी. कोड',$this->w,$this->x,'S','C',1,'siddhanta',11);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
    ...
    function detail_1(&$group_row_1)
    {
        ...
        $this->setfieldwidth(15);
        $this->textbox($group_row_1['EMPLOYEECODE'],$this->w,$this->x,'S','C',1,'SakalMarathiNormal922',10);
        $this->vline($this->liney-1,$this->liney+7,$this->x+$this->w);
        
        $this->setfieldwidth(45);
        $this->textbox($group_row_1['EMPLOYEENAMEUNI'],$this->w,$this->x,'S','L',1,'siddhanta',10);
        $this->vline($this->liney-1,$this->liney+7,$this->x+$this->w);

        $this->setfieldwidth(40);
        $this->textbox($group_row_1['BANKBRANCHNAME'],$this->w,$this->x,'S','L',1,'SakalMarathiNormal922',10);
        $this->vline($this->liney-1,$this->liney+7,$this->x+$this->w);
        ...
        $this->setfieldwidth(30);
        $this->textbox($group_row_1['IFSCCODE'],$this->w,$this->x,'S','L',1,'SakalMarathiNormal922',10);
        $this->vline($this->liney-1,$this->liney+7,$this->x+$this->w);
       
        $this->setfieldwidth(20);
        $this->textbox($group_row_1['NETSALARY'],$this->w,$this->x,'S','R',1,'SakalMarathiNormal922',10);
        $this->vline($this->liney-1,$this->liney+7,$this->x+$this->w);

        $this->summary["amount"]+=$group_row_1['NETSALARY'];
    ...
    function reportfooter()
    {
        ...
        $this->vline($this->liney-1,$this->liney+7,$this->x+$this->w);
        $this->newrow();
        $this->hline(155,205,$this->liney,'C'); 
