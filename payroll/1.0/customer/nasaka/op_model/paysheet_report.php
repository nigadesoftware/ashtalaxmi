...
{	
    ...
    { 
       ...
       // $this->textbox($this->ftransactionnumber['FARMERCOUNT'],175,10,'S','C',1,'siddhanta',13);
         ...
         $this->newrow(10);
        $this->textbox('पगार पत्रक माहे-'.$this->monthname.' '.$_SESSION['yearperiodcode'],290,10,'S','C',1,'siddhanta',13);
       ...
       $this->newrow(); 
        ...
        $this->textbox('कोड',$this->w,$this->x,'S','L',1,'siddhanta',12,'','','','B'); 
        $this->setfieldwidth(50);
        $this->textbox('नाव',$this->w,$this->x,'S','L',1,'siddhanta',12,'','','','B'); 
        $this->setfieldwidth(25);
        $this->textbox('UAN',$this->w,$this->x,'S','L',1,'siddhanta',12); 
        $this->setfieldwidth(50);
        $this->textbox('बँकेचे नाव',$this->w,$this->x,'S','L',1,'siddhanta',11,'','','',''); 
        $this->setfieldwidth(30);
        $this->textbox('बँकेचे खाते नं',$this->w,$this->x,'S','L',1,'siddhanta',11,'','','',''); 
        $this->setfieldwidth(30);
        $this->textbox('हजर दिवस',$this->w,$this->x,'S','L',1,'siddhanta',11,'','','',''); 
        $this->newrow(); 
      $this->hline(10,290,$this->liney,'C');
    ...
    function group()
    {
       ...
       and et.fromdate<=p.fromdate and nvl(et.todate,'31-dec-2030') > p.fromdate
       and {$cond}
    ...
    { 
        ...
        if ($this->isnewpage(15))
      {
        ...
        $this->textbox('विभाग: '.$group_row_1['SECTIONNAMEUNI'].'    प्रकार  :'.$group_row_1['EMPLOYEECATEGORYNAMEUNI'],$this->w,$this->x,'S','L',1,'siddhanta',12,'','','','B');  
    ...
    function groupheader_2(&$group_row_1)
    {
        ...
        $this->textbox($group_row_1['EMPLOYEENAMEUNI'],$this->w,$this->x,'S','L',1,'siddhanta',12,'','','','B'); 
        $this->setfieldwidth(25);
        $this->textbox($group_row_1['UAN'],$this->w,$this->x,'S','L',1,'siddhanta',12); 
        $this->setfieldwidth(50);
        $this->textbox($group_row_1['BANKBRANCHNAME'],$this->w,$this->x,'S','L',1,'SakalMarathiNormal922',11,'','','',''); 
        $this->setfieldwidth(30);
        $this->textbox($group_row_1['ACCOUNTNUMBER'],$this->w,$this->x,'S','L',1,'SakalMarathiNormal922',8,'','','',''); 
        $this->setfieldwidth(30);
        $this->textbox($group_row_1['PRESENTDAYS'],$this->w,$this->x,'S','L',1,'SakalMarathiNormal922',11,'','','',''); 
        $this->newrow();
       ...
       // $this->newrow();
        ...
        order by ea.allowancecategorycode
         ...
         $this->textbox('मिळकत',$this->w,$this->x,'S','L',1,'siddhanta',11); 
         $this->textbox('मिळकत',$this->w,$this->x,'S','L',1,'siddhanta',11); 
         //$this->newrow();
         ...
         while ($row = oci_fetch_array($result,oci_assoc+OCI_RETURN_NULLS))
         {
          ...
          $this->newrow();
          $this->hline(30,240,$this->liney-2,'D');
          $cond="1=1";
        $cond=$cond." and p.financialyearcode=".$_SESSION['yearperiodcode'];  
        if ($this->monthcode!=0)
        {
        ...
        while ($row = oci_fetch_array($result,oci_assoc+OCI_RETURN_NULLS))
        {
          ...
          $this->textbox('निव्वळ अदा ',$this->w,$this->x,'S','L',1,'siddhanta',11);
          $this->setfieldwidth(25);
