...
protected function checkmindatalength($data,$datalabel,$datalength)
    ...
    public function label($fieldname,$englishlabel,$unicodelabel)
    {
        ...
        {
            echo '<tr>';
            echo '<td><label for="'.$fieldname.'" id="lbl_'.$fieldname.'" class="thick">'.$englishlabel.'</label></td>';
            echo '</tr>';
        }
        else
        {
            echo '<tr>';
            echo '<td><label for="'.$fieldname.'" id="lbl_'.$fieldname.'" class="thick">'.$unicodelabel.'</label></td>';
            echo '</tr>';
        }
	}
    public function textcombobox($fieldname,$combosearchfield,$combocodefield,$englishlabel,$unicodelabel,$value='',$codevalue='',$width=300,$height=150,$iscompulsory=False,$isreadonly=False,$found=false,$flag='',$js='',$isautofocus=false,$searchtextbox='')
    {
		if ($searchtextbox=='')
		{
			$this->textbox($combosearchfield,$englishlabel,$unicodelabel,$value,$width,$height,'left',$iscompulsory,$isreadonly,$found,$flag,$js,$isautofocus);
		}
		else
		{
			$this->textbox($searchtextbox,$englishlabel,$unicodelabel,$value,$width,$height,'left',$iscompulsory,$isreadonly,$found,$flag,$js,$isautofocus);
		}
        if ($found==false)
        {
            echo '<tr>';
    ...
    public function textbox($fieldname,$englishlabel,$unicodelabel,$value='',$width=300,$height=150,$align='left',$iscompulsory=False,$isreadonly=False,$found=false,$flag='',$js='',$isautofocus=false,$isplaceholder=false,$placeholder='')
    {
		$this->label($fieldname,$englishlabel,$unicodelabel);
        ...
        {
			echo '<tr>';
			echo '<td><input autocomplete="off" type="text" readonly="readonly" tabindex="-1" style="font-size:12pt;height:'.$height.'px;width:'.$width.'px;'.'text-align:'.$align.';" name="'.$fieldname.'" id="'.$fieldname.'" value="'.$value.'" placeholder="'.$ph.'"></td>';
		}
		elseif ($isreadonly==True and $flag=='Query')
        {
			...
			if ($isautofocus==true)
			{
				echo '<td><input autocomplete="off" autofocus type="text" style="font-size:12pt;height:'.$height.'px;width:'.$width.'px;'.'text-align:'.$align.';" name="'.$fieldname.'" id="'.$fieldname.'" value="'.$value.'" placeholder="'.$ph.'"></td>';
			}
			else
			{
				echo '<td><input autocomplete="off" type="text" style="font-size:12pt;height:'.$height.'px;width:'.$width.'px;'.'text-align:'.$align.';" name="'.$fieldname.'" id="'.$fieldname.'" value="'.$value.'" placeholder="'.$ph.'"></td>';
			}
		}
        else
        {
            ...
            else
            {
				...
				if ($isautofocus==true)
				{
					echo '<td><input autocomplete="off" autofocus type="text" style="font-size:12pt;height:'.$height.'px;width:'.$width.'px;'.'text-align:'.$align.';" name="'.$fieldname.'" id="'.$fieldname.'" value="'.$value.'" placeholder="'.$ph.'" '.$js.'></td>';
				}
				else
				{
					echo '<td><input autocomplete="off" type="text" style="font-size:12pt;height:'.$height.'px;width:'.$width.'px;'.'text-align:'.$align.';" name="'.$fieldname.'" id="'.$fieldname.'" value="'.$value.'" placeholder="'.$ph.'" '.$js.'></td>';
				}
            }
        }
        if ($iscompulsory==True)
        {
            echo '<td><label for="'.$fieldname.'" id="lbls_'.$fieldname.'">*</label></td>';
            echo '</tr>';
        }
        else
        {
	...
	function textcomboname(&$connection,$table,$datafield,$datafieldvalue,$engfield,$unicodefield)
	{
		if ($_SESSION['lng']=="English")
		{ 
