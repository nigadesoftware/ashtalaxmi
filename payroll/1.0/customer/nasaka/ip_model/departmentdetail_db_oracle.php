<?php
//This is generated by Nigade Software Technologies (opc) Private Limited 09/01/2021 01:56:39 pm for PHP
require_once("../swappbase/formbase.php");
class departmentdetail extends swappform
{
    ...
    public function insert()
    {
        ...
        {
            $query = "select nvl(max(departmentcode),0)+1 as departmentcode from departmentdetail";
    ...
    public function display()
	  {
        ...
        if ($cond!='')
		    {
		        $query = "select t.* from departmentdetail t where ".$cond." order by departmentcode";
			      $result = oci_parse($this->connection, $query);
            $r = oci_execute($result);
			      return $result;
		     }
		     ...
		     {
		         $query = "select t.* from departmentdetail t order by departmentcode";
			       $result = oci_parse($this->connection, $query);
             $r = oci_execute($result);
			       return $result;
		     }
