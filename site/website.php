...
<html>
    <head>
        ...
        <title>Cloud Websites</title>
        <meta property="og:image" content="http://www.swapp.co.in/img/cloudwebsites.png">
    ...
    <body>
        ...
        <div class="row">
            <div class="box">
                ...
                <img border="0" alt="Cloud Websites" src="../img/cloudwebsites.png">
                <p>1. Mobile First Websites are designed for Mobiles but also responsive on PC and Laptop</br>
                2. As there are different mobile sizes, it adjust itself accordingly</br>
                3. Information language is not the constraint because of the Unicode</br>
                4. Quality graphics with digital photos can be used</br>
                5. Information in time updation within time frame</br>
                6. Business E-mail Account facilities</br>
                7. Search Engine Optimization (SEO) for Google and Bing</br>
                </p>
        </div>
        </div>
