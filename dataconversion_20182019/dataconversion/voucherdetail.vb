...
Public Partial Class voucherdetail
	...
	Sub convertdetail()
		Try 
			...
			"And h.vfin_year='2018-2019' And h.nvou_status=9 and t.nac_code=m.refcode  and t.vind_code is null union all Select t.*,m.accountcode,s.subledgercode,h.nvou_sub_type from ac_voucher_header h "  & _ 
			",ac_voucher_detail t,accounthead m ,accountsubledger s where h.ntrans_no=t.ntrans_no And h.vfin_year='2018-2019' And h.nvou_status=9 and t.nac_code=m.refcode and m.accountcode=s.accountcode "  & _ 
