<?php
   ...
   if ($searchTerm == '**')
   {
       $query = "select b.finishedgoodscode
        ...
        ,b.memonumberpresuf
        ,b.salememotransactionnumber
        ,b.productionyearcode
        ,b.balancequantity
        from memobalance b 
        where b.salememotransactionnumber=".$saleinvoiceheader1->salememotransactionnumber." and b.balancequantity>0";
   }
   else
   {
       $query = "select b.finishedgoodscode
        ...
        ,b.balancequantity
        from memobalance b
        where b.salememotransactionnumber=".$saleinvoiceheader1->salememotransactionnumber." and b.balancequantity>0 and (upper(FINISHEDGOODSNAMEENG) like upper('%".$searchTerm."%')
   ...
   while ($row = oci_fetch_array($result,OCI_ASSOC+OCI_RETURN_NULLS))
   {
       ...
       $memonumberpresuf = $row['MEMONUMBERPRESUF'];
       $salememotransactionnumber = $row['SALEMEMOTRANSACTIONNUMBER'];
