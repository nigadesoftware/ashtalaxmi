...
protected function checkmindatalength($data,$datalabel,$datalength)
    ...
    public function textbox($fieldname,$englishlabel,$unicodelabel,$value='',$width=300,$height=150,$align='left',$iscompulsory=False,$isreadonly=False,$found=false,$flag='',$js='',$isautofocus=false)
    {
        $this->label($fieldname,$englishlabel,$unicodelabel);
        if ($isreadonly==True and $flag!='Query')
        {
			echo '<tr>';
			echo '<td><input autocomplete="off" type="text" readonly="readonly" tabindex="-1" style="font-size:12pt;height:'.$height.'px;width:'.$width.'px;'.'text-align:'.$align.';" name="'.$fieldname.'" id="'.$fieldname.'" value="'.$value.'"></td>';
		}
		elseif ($isreadonly==True and $flag=='Query')
        {
			...
			if ($isautofocus==true)
			{
				echo '<td><input autocomplete="off" autofocus type="text" style="font-size:12pt;height:'.$height.'px;width:'.$width.'px;'.'text-align:'.$align.';" name="'.$fieldname.'" id="'.$fieldname.'" value="'.$value.'"></td>';
			}
			else
			{
				echo '<td><input autocomplete="off" type="text" style="font-size:12pt;height:'.$height.'px;width:'.$width.'px;'.'text-align:'.$align.';" name="'.$fieldname.'" id="'.$fieldname.'" value="'.$value.'"></td>';
			}
		}
        else
        {
            ...
            else
            {
				...
				if ($isautofocus==true)
				{
					echo '<td><input autocomplete="off" autofocus type="text" style="font-size:12pt;height:'.$height.'px;width:'.$width.'px;'.'text-align:'.$align.';" name="'.$fieldname.'" id="'.$fieldname.'" value="'.$value.'" '.$js.'></td>';
				}
				else
				{
					echo '<td><input autocomplete="off" type="text" style="font-size:12pt;height:'.$height.'px;width:'.$width.'px;'.'text-align:'.$align.';" name="'.$fieldname.'" id="'.$fieldname.'" value="'.$value.'" '.$js.'></td>';
				}
            }
        }
        if ($iscompulsory==True)
