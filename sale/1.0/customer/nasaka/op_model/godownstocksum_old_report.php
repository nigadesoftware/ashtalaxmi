...
{	
	...
	function pageheader()
    {
        ...
        $this->textbox('Godown',20,65,'S','L',1,'verdana',10);
        $this->textbox('Lot',10,85,'S','R',1,'verdana',10);
        $this->textbox('Op.Bal',20,95,'S','R',1,'verdana',10);
        $this->textbox('Inward',20,115,'S','R',1,'verdana',10);
        $this->textbox('Outward',20,135,'S','R',1,'verdana',10);
        $this->textbox('Cl.Bal(in Qtl)',30,155,'S','R',1,'verdana',10);
        $this->hline(10,200,$this->liney+6,'C');
        $this->newrow();
    ...
    function detail()
    {
        $query ="select t.productionyearcode,y.periodname_eng from (        
        ...
        and f.goodscategorycode=".$this->goodscategorycode."
        and t.finishedgoodscode=f.finishedgoodscode
        group by t.productionyearcode,t.godownnumber,t.finishedgoodscode,t.lotnumber,f.shortname)t,nst_nasaka_db.yearperiod y
        where t.productionyearcode=y.yearperiodcode and 
        openingdebitquantity>0 or openingcreditquantity>0 or debitquantity>0 or creditquantity>0 or closingdebitquantity>0 or closingcreditquantity>0
        group by t.productionyearcode,y.periodname_eng
        order by t.productionyearcode asc";
        ...
        {
            $this->textbox('Production Season:'.$row['PERIODNAME_ENG'],80,10,'S','L',1,'verdana',10);
            $this->newrow();
            
            $query1 ="select t.*,y.periodname_eng from (select productionyearcode,finishedgoodscode,shortname
            ...
            and t.finishedgoodscode=f.finishedgoodscode
            group by t.productionyearcode,t.godownnumber,t.finishedgoodscode,t.lotnumber,f.shortname)
            group by productionyearcode,finishedgoodscode,shortname
            having productionyearcode=".$row['PRODUCTIONYEARCODE'].
            ")t,nst_nasaka_db.yearperiod y
            where t.productionyearcode=y.yearperiodcode
            and openingquantity>0 or debitquantity>0 or creditquantity>0 or closingquantity>0 
            order by finishedgoodscode asc,shortname asc";
            ...
            {
                $query2 ="select t.*,y.periodname_eng 
                from (
                ...
                "')t,nst_nasaka_db.yearperiod y
                where t.productionyearcode=y.yearperiodcode and openingquantity>0 or debitquantity>0 or creditquantity>0 or closingquantity>0 
                ...
                while ($row2 = oci_fetch_array($result2,OCI_ASSOC+OCI_RETURN_NULLS))
                {
                    ...
                    $this->textbox($row2['GODOWNNUMBER'],20,65,'S','C',1,'verdana',9);
                    $this->textbox($row2['LOTNUMBER'],10,85,'S','C',1,'verdana',9);
                    $this->textbox($row2['OPENINGQUANTITY'],20,95,'S','R',1,'verdana',9);
                    $this->textbox($row2['DEBITQUANTITY'],20,115,'S','R',1,'verdana',9);
                    $this->textbox($row2['CREDITQUANTITY'],20,135,'S','R',1,'verdana',9);
                    $this->textbox($row2['CLOSINGQUANTITY'],20,155,'S','R',1,'verdana',9);
                    $this->newrow(5);
                ...
                $this->textbox($openingquantity2,20,95,'S','R',1,'verdana',9);
                $this->textbox($debitquantity2,20,115,'S','R',1,'verdana',9);
                $this->textbox($creditquantity2,20,135,'S','R',1,'verdana',9);
                $this->textbox($closingquantity2,20,155,'S','R',1,'verdana',9);
                $this->newrow(5);
                $this->hline(10,200,$this->liney,'C');  
            ...
            $this->hline(10,200,$this->liney,'C'); 
            $this->textbox('Total '.$row['PERIODNAME_ENG'],100,15,'S','L',1,'verdana',9); 
            $this->textbox($openingquantity1,20,95,'S','R',1,'verdana',9);
            $this->textbox($debitquantity1,20,115,'S','R',1,'verdana',9);
            $this->textbox($creditquantity1,20,135,'S','R',1,'verdana',9);
            $this->textbox($closingquantity1,20,155,'S','R',1,'verdana',9);
            $this->newrow();
            $this->hline(10,200,$this->liney,'C');
        ...
        $this->textbox($openingquantity,20,95,'S','R',1,'verdana',9);
        $this->textbox($debitquantity,20,115,'S','R',1,'verdana',9);
        $this->textbox($creditquantity,20,135,'S','R',1,'verdana',9);
        $this->textbox($closingquantity,20,155,'S','R',1,'verdana',9);
        $this->newrow();
        $this->hline(10,200,$this->liney,'C');
        ...
        $this->textbox('Godown',30,10,'S','L',1,'verdana',11);
        $this->textbox('Op. Bal',30,40,'S','R',1,'verdana',11);
        $this->textbox('Inward',30,70,'S','R',1,'verdana',11);
        $this->textbox('Outward',30,100,'S','R',1,'verdana',11);
        $this->textbox('Cl.Bal(in Qtl)',30,130,'S','R',1,'verdana',11);
        $this->newrow();
        $this->hline(10,160,$this->liney);    
        ...
        while ($row = oci_fetch_array($result,OCI_ASSOC+OCI_RETURN_NULLS))
        {
            $this->textbox($row['GODOWNNUMBER'],30,10,'S','C',1,'verdana',9);
            $this->textbox($row['OPENINGQUANTITY'],30,40,'S','R',1,'verdana',9);
            $this->textbox($row['DEBITQUANTITY'],30,70,'S','R',1,'verdana',9);
            $this->textbox($row['CREDITQUANTITY'],30,100,'S','R',1,'verdana',9);
        ...
        $this->textbox('Total',30,10,'S','C',1,'verdana',9);
        $this->textbox($openingquantity,30,40,'S','R',1,'verdana',9);
        $this->textbox($debitquantity,30,70,'S','R',1,'verdana',9);
        $this->textbox($creditquantity,30,100,'S','R',1,'verdana',9);
        $this->textbox($closingquantity,30,130,'S','R',1,'verdana',9);
        $this->newrow(5);
        $this->hline(10,160,$this->liney);
        $liney = $this->liney;
        ...
        $this->newrow();
        $blockstartliney = $this->liney;
        $this->hline(10,170,$this->liney);    
        $this->textbox('Prod.Season',20,10,'S','L',1,'verdana',11);
        $this->textbox('Op.Bal',20,30,'S','R',1,'verdana',11);
        $this->textbox('Inward',20,50,'S','R',1,'verdana',11);
        $this->textbox('Outward',80,70,'S','C',1,'verdana',11);
        $this->textbox('Cl.Bal(in Qtl)',20,150,'S','R',1,'verdana',11,'','Y');
        $this->newrow();
        $this->textbox('Free',20,70,'S','L',1,'verdana',11);
        $this->textbox('Levy',20,90,'S','L',1,'verdana',11);
        $this->textbox('Export',20,110,'S','L',1,'verdana',11);
        $this->textbox('Trf/Repr',20,130,'S','L',1,'verdana',11);
        $this->newrow();
        $this->hline(10,170,$this->liney);    
        $query ="select t.*,y.periodname_eng from (select productionyearcode
        ...
        ,case when salecategorycode=2 then sum(creditquantity) else 0 end levy
        ...
        group by productionyearcode)t,nst_nasaka_db.yearperiod y
        where t.productionyearcode=y.yearperiodcode
        and openingquantity>0 or debitquantity>0 or free>0 or levy>0 or export>0 or trf>0 or closingquantity>0 
        ...
        while ($row = oci_fetch_array($result,OCI_ASSOC+OCI_RETURN_NULLS))
        {
            $this->textbox($row['PERIODNAME_ENG'],20,10,'S','R',1,'verdana',9);
            $this->textbox($row['OPENINGQUANTITY'],20,30,'S','R',1,'verdana',9);
            $this->textbox($row['DEBITQUANTITY'],20,50,'S','R',1,'verdana',9);
            $this->textbox($row['FREE'],20,70,'S','R',1,'verdana',9);
            $this->textbox($row['LAVY'],20,90,'S','R',1,'verdana',9);
            $this->textbox($row['EXPORT'],20,110,'S','R',1,'verdana',9);
            $this->textbox($row['TRF'],20,130,'S','R',1,'verdana',9);
            $this->textbox($row['CLOSINGQUANTITY'],20,150,'S','R',1,'verdana',9);
            $this->newrow(5);
            $this->hline(10,170,$this->liney);    
            $openingquantity = $openingquantity + $row['OPENINGQUANTITY'];
            $debitquantity = $debitquantity + $row['DEBITQUANTITY'];
        ...
        $this->textbox($free,20,70,'S','R',1,'verdana',9);
        $this->textbox($levy,20,90,'S','R',1,'verdana',9);
        $this->textbox($export,20,110,'S','R',1,'verdana',9);
        $this->textbox($trf,20,130,'S','R',1,'verdana',9);
        $this->textbox($closingquantity,20,150,'S','R',1,'verdana',9);
        $this->newrow(5);
        $this->hline(10,170,$this->liney);
        $liney = $this->liney;
        $this->liney = $blockstartliney;
        ...
        $this->vline($this->liney,$liney,70);
        $this->hline(70,150,$this->liney+7);
        $this->vline($this->liney+7,$liney,90);
        $this->vline($this->liney+7,$liney,110);
        $this->vline($this->liney+7,$liney,130);
        $this->vline($this->liney,$liney,150);
        $this->vline($this->liney,$liney,170);
        $this->hline(10,170,$liney);
        $this->liney = $liney;
        $this->newrow(15);
