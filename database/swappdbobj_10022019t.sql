...
-- Created by admin on 10/02/2019, 20:40:26 --
----------------------------------------------

spool swappdbobj_10022019t.log
...
(
  FINANCIALYEAR  VARCHAR2(9) not null,
...
alter table nst_nasaka_FINANCE.ACCOUNTSUBLEDGER
  add constraint FKACCOUNTCODESUBLEDGERTYPECODE foreign key (ACCOUNTCODE, SUBLEDGERTYPECODE)
  references nst_nasaka_FINANCE.ACCOUNTHEADDETAIL (ACCOUNTCODE, SUBLEDGERTYPECODE);
alter table nst_nasaka_FINANCE.ACCOUNTSUBLEDGER
...
prompt
prompt Creating table AC_IND_OTHERS
prompt ============================
prompt
create table nst_nasaka_FINANCE.AC_IND_OTHERS
(
  VIND_CODE         VARCHAR2(10) not null,
  VIND_NAME         VARCHAR2(100) not null,
  NIND_TYPE         NUMBER,
  VOLD_CODE         VARCHAR2(10),
  VADDRESS          VARCHAR2(250),
  NMULTIPLE_ACIVITY NUMBER(1) default 0,
  VIND_NAME_MARATHI VARCHAR2(100) not null
)
;
alter table nst_nasaka_FINANCE.AC_IND_OTHERS
  add constraint PK_IND_CODE primary key (VIND_CODE);
alter table nst_nasaka_FINANCE.AC_IND_OTHERS
  add constraint NQ_NAME unique (VIND_NAME);

prompt
prompt Creating table AC_ML
prompt ====================
prompt
create table nst_nasaka_FINANCE.AC_ML
(
  NAC_CODE          NUMBER not null,
  VAC_NAME          VARCHAR2(150) not null,
  NSUB_GROUP        NUMBER,
  NSECTION_CODE     NUMBER default 0,
  NFARM_CODE        NUMBER,
  NROEP_CODE        NUMBER,
  NACTIVITY_CODE    NUMBER,
  NDEP_PER          NUMBER,
  NNOR_SUB_BANK     NUMBER(1) default 1,
  NGROUP_CODE       NUMBER,
  NSUB_SUBGROUP     NUMBER,
  NBB_JB            NUMBER,
  NIND_TYPE         NUMBER,
  NINT_AC_CODE      NUMBER,
  NDR_AC_CODE       NUMBER,
  NINT_RATE         NUMBER,
  VAC_NAME_MARATHI  VARCHAR2(150) not null,
  VDAY_BOOK_DETAILS VARCHAR2(1) default 'B',
  VCANE_LEDGER      VARCHAR2(1),
  VNO_NARRATION     VARCHAR2(1),
  NFLAG_PREFIX      NUMBER
)
;
alter table nst_nasaka_FINANCE.AC_ML
  add constraint PK_AC_CODE primary key (NAC_CODE);

prompt
prompt Creating table AC_VOUCHER_HEADER
prompt ================================
prompt
create table nst_nasaka_FINANCE.AC_VOUCHER_HEADER
(
  NTRANS_NO         NUMBER not null,
  VFIN_YEAR         VARCHAR2(9),
  DVOU_DATE         DATE,
  NVOU_TYPE         NUMBER,
  NVOU_NUMBER       NUMBER,
  NPREPARED_BY_USER VARCHAR2(10),
  NPASS_BY_USER     VARCHAR2(10),
  NVOU_STATUS       NUMBER default 1,
  NCASHIER_USER     VARCHAR2(10),
  TPREPARED_TIME    DATE default SYSDATE,
  TPASS_TIME        DATE,
  TCASHIER_TIME     DATE,
  VNARRATION        VARCHAR2(600),
  VFROM_TO          VARCHAR2(100),
  NBANK_CODE        NUMBER,
  NCH_CQ            NUMBER(1),
  VREC_FROM         VARCHAR2(100),
  NREC_NUMBER       NUMBER,
  DREC_DATE         DATE,
  VCQ_DD_NO         VARCHAR2(150),
  VCR_DR_JV         VARCHAR2(1),
  NREC_TRANS_NO     NUMBER,
  NOFFICER_USER     VARCHAR2(10),
  TOFFICER_TIME     DATE,
  NAUTO_VOUCHER     NUMBER,
  NVOU_SUB_TYPE     NUMBER not null,
  NOFFICER_UPP_USER VARCHAR2(10),
  TOFFICER_UPP_TIME DATE,
  NRECEIPT          NUMBER(1)
)
;
alter table nst_nasaka_FINANCE.AC_VOUCHER_HEADER
  add constraint PK_TRANS_NO primary key (NTRANS_NO);
create index nst_nasaka_FINANCE.CHCQ on nst_nasaka_FINANCE.AC_VOUCHER_HEADER (NCH_CQ);
create index nst_nasaka_FINANCE.CRDR on nst_nasaka_FINANCE.AC_VOUCHER_HEADER (VCR_DR_JV);
create index nst_nasaka_FINANCE.FINYR on nst_nasaka_FINANCE.AC_VOUCHER_HEADER (VFIN_YEAR);
create index nst_nasaka_FINANCE.VDT on nst_nasaka_FINANCE.AC_VOUCHER_HEADER (DVOU_DATE);
create index nst_nasaka_FINANCE.VNO on nst_nasaka_FINANCE.AC_VOUCHER_HEADER (NVOU_NUMBER);
create index nst_nasaka_FINANCE.VST on nst_nasaka_FINANCE.AC_VOUCHER_HEADER (NVOU_STATUS);

prompt
prompt Creating table AC_VOUCHER_CHEQUE_DD_DETAIL
prompt ==========================================
prompt
create table nst_nasaka_FINANCE.AC_VOUCHER_CHEQUE_DD_DETAIL
(
  NTRANS_NO          NUMBER not null,
  NVOU_TRANS_NO      NUMBER not null,
  NTYPE              NUMBER(2) not null,
  NNUMBER            NUMBER not null,
  DDATE              DATE not null,
  NDRAWEE_BANK       NUMBER,
  VDRAWEE_BANK       VARCHAR2(150),
  NAMOUNT            NUMBER not null,
  DDEPO_ISS_DATE     DATE,
  NACCOUNT_CODE_BANK NUMBER,
  DCLEAR_DATE        DATE,
  VCR_DR             CHAR(1),
  DDIS_DATE          DATE
)
;
alter table nst_nasaka_FINANCE.AC_VOUCHER_CHEQUE_DD_DETAIL
  add constraint PK_TRANS_VOU primary key (NTRANS_NO);
alter table nst_nasaka_FINANCE.AC_VOUCHER_CHEQUE_DD_DETAIL
  add constraint FK_VOU_TRANS foreign key (NVOU_TRANS_NO)
  references nst_nasaka_FINANCE.AC_VOUCHER_HEADER (NTRANS_NO) on delete cascade;

prompt
prompt Creating table AC_VOUCHER_DETAIL
prompt ================================
prompt
create table nst_nasaka_FINANCE.AC_VOUCHER_DETAIL
(
  NTRANS_NO     NUMBER not null,
  NSR_NO        NUMBER not null,
  NAC_CODE      NUMBER,
  VIND_CODE     VARCHAR2(10),
  NCR_AMT       NUMBER default 0,
  NDR_AMT       NUMBER default 0,
  VREMARK       VARCHAR2(150),
  NBANK_AUTO    NUMBER default 0,
  NSECTION_CODE NUMBER default 0,
  VDESC         VARCHAR2(2000),
  VPAGE_NO      NUMBER
)
;
alter table nst_nasaka_FINANCE.AC_VOUCHER_DETAIL
  add constraint PK_TRAN_SR_NO primary key (NTRANS_NO, NSR_NO);
alter table nst_nasaka_FINANCE.AC_VOUCHER_DETAIL
  add constraint FK_TRAN_SR_NO foreign key (NTRANS_NO)
  references nst_nasaka_FINANCE.AC_VOUCHER_HEADER (NTRANS_NO) on delete cascade;
create index nst_nasaka_FINANCE.ACCD on nst_nasaka_FINANCE.AC_VOUCHER_DETAIL (NAC_CODE);
create index nst_nasaka_FINANCE.INDCD on nst_nasaka_FINANCE.AC_VOUCHER_DETAIL (VIND_CODE);

prompt
prompt Creating table AC_VOUCHER_NUMBERING
prompt ===================================
prompt
create table nst_nasaka_FINANCE.AC_VOUCHER_NUMBERING
(
  VFIN_YEAR     VARCHAR2(9) not null,
  NVOU_TYPE     NUMBER not null,
  NCH_CQ        NUMBER not null,
  NVOU_NUMBER   NUMBER not null,
  NTRANS_NO     NUMBER not null,
  TTIME         DATE default sysdate,
  VCR_DR_JV     VARCHAR2(1) not null,
  DVOU_DATE     DATE not null,
  NSUB_VOU_TYPE NUMBER
)
;
alter table nst_nasaka_FINANCE.AC_VOUCHER_NUMBERING
  add constraint PK_VOU_NO primary key (NVOU_TYPE, NCH_CQ, NVOU_NUMBER, VCR_DR_JV, DVOU_DATE);
alter table nst_nasaka_FINANCE.AC_VOUCHER_NUMBERING
  add constraint FK_VOU_TRNS foreign key (NTRANS_NO)
  references nst_nasaka_FINANCE.AC_VOUCHER_HEADER (NTRANS_NO) on delete cascade;
...
alter table nst_nasaka_FINANCE.BUDGET
  add constraint FKBUDGET foreign key (ACCOUNTCODE)
  references nst_nasaka_FINANCE.ACCOUNTHEAD (ACCOUNTCODE);
...
alter table nst_nasaka_FINANCE.VOUCHERCHEQUEDDDETAIL
  add constraint FKBANKACCOUNTCODE foreign key (BANKACCOUNTCODE)
  references nst_nasaka_FINANCE.ACCOUNTHEAD (ACCOUNTCODE);
alter table nst_nasaka_FINANCE.VOUCHERCHEQUEDDDETAIL
...
alter table nst_nasaka_FINANCE.VOUCHERDETAIL
  add constraint FKACCOUNTCODE foreign key (ACCOUNTCODE)
  references nst_nasaka_FINANCE.ACCOUNTHEAD (ACCOUNTCODE);
alter table nst_nasaka_FINANCE.VOUCHERDETAIL
...
union all
select  h.yearperiodcode ,h.legalentitycode,h.voucherdate cdate, d.accountcode,d.subledgercode ,nvl(d.debit,0)debit,nvl(d.credit,0)credit  from voucherheader h,voucherdetail d
...
select nvl(max(t.transactionnumber),0)+1 into mtransactionnumber
 ...
 mlosscur := mcredit-mdebit;
 mprofitcur:=0;
 end if;
 open op_cur;
 fetch op_cur into mopprofitcur,moplosscur;
 close op_cur;
 ...
 mlosspre := mcredit-mdebit;
 mprofitpre:=0;
 end if;
 open op_pre;
 fetch op_pre into mopprofitpre,moplosspre;
 close op_pre;
