<?php
    ...
    //Petrol Pump Master Addition and Petrol Pump Master Alteration
    ...
    <body>
        ...
        <article class="w3-container">
            ...
            <?php
                ...
                $query = "select n.* from namedetail n where namecategoryid=".$namecategoryid_de." and namedetailid=".$namedetailid_de;
                $result = oci_parse($connection, $query); $r = oci_execute($result);
                $r = oci_execute($result);
                if ($row = oci_fetch_array($result,OCI_ASSOC+OCI_RETURN_NULLS)) 
                {
                    ...
                    if ($flag_de == 'Display')
                    {
                        echo '<form method="post" action="../ip_controller/masterbase_action.php">';
                    }
                    echo '<table border="0" >';
