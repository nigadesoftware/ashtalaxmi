						...
						if (mysqli_connect_errno())
						  ...
						  echo "Communication Error";
							...
							if ($_SESSION["responsibilitycode"] == 621478512368915 or $_SESSION["responsibilitycode"] == 785236954125917)
                    			{
                    				...
                    				echo '<td><img src="../img/U.png" width="16px" height="31px"><a style="color:#4a4" class="servicebar" href="../ip_view/user.php?userid='.$userid_en.'&flag=new">New User</a><br/>';
                					echo '</tr>';
                				}
							while ($row = oci_fetch_array($result,OCI_ASSOC))
							{
                        		...
                        		echo '<td><img src="../img/U.png" width="16px" height="31px"><a style="color:#000" class="servicebar" href="../ip_view/userresponsibility_list.php?userid='.$userid_en.'">'.$row['MISUSERNAME'].'</A>';
		                        if ($_SESSION["responsibilitycode"] == 621478512368915 or $_SESSION["responsibilitycode"] == 785236954125917)
                    			{
		                        	echo '<td><a style="color:#333" class="servicebar" href="../ip_view/user.php?userid='.$userid_en.'&flag=view'.'"><img border="0" alt="पहा (View)" src="../img/viewdata.png" width="18" height="10"></br></a>';
		                        	echo '<td><a style="color:#333" class="servicebar" href="../ip_view/user.php?userid='.$userid_en.'&flag=change'.'"><img border="0" alt="बदल (Change)" src="../img/changedata.png" width="18" height="10"></br></a>';
                    			}
                    			echo '</tr>';
							}
							echo "</table>";
