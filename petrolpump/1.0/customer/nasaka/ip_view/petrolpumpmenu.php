				...
				<?php
					...
					if ($_SESSION["responsibilitycode"] == 123457306 or $_SESSION["responsibilitycode"] == 123457406)
					{
						...
						echo '<ul class="servicebar">';
							...
							echo '<li><a class="servicebar" href="../ip_view/saleheader.php?shiftcode='.$shiftcode_en.'&transactioncategoryid='.$transactioncategoryid_en.'">Credit Sale</a>';
							$transactioncategoryid_en = fnEncrypt('1');
							echo '<li><a class="servicebar" href="../ip_view/saleheader.php?shiftcode='.$shiftcode_en.'&transactioncategoryid='.$transactioncategoryid_en.'">Cash Sale</a>';
