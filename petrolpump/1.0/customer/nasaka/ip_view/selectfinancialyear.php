						...
						/*if (mysqli_connect_errno())
						  {
							...
							while ($row = oci_fetch_array($result,OCI_ASSOC+OCI_RETURN_NULLS))
							{
                        		...
                        		$finalreportperiodid_en = fnEncrypt($row['YEARPERIODCODE']);
								echo '<td><a class="servicebar" href="../sqlproc/selectedfinancialyear.php?finalreportperiodid='.$finalreportperiodid_en.'">'.$row['PERIODNAME_ENG'].'</a>';
                        		//echo '<td><a class="servicebar" href="../ip_view/entitymenu.php?finalreportperiodid='.$finalreportperiodid_en.'">'.$row['PERIODNAME'].' ('.$row['PERIODNAME_ENG'].')</A>';
                    			echo '</tr>';
							}
							echo "</table>";
					?>
