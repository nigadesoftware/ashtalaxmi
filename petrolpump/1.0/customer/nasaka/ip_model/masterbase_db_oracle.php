...
{	
	...
	{
		$this->start_validation();
		$query = "select count(*) as cnt from namedetail n where  n.name_eng='".$this->name_eng."' and n.name_unicode='".$this->name_unicode."'";
	...
	private function idvalidation()
	{
		...
		$query = "select count(*) as cnt from namedetail n where  n.namedetailid=".$this->namedetailid;
		/* $result = mysqli_query($this->connection, "select count(*) as cnt from namedetail n,masterbase a where n.namedetailid=a.namedetailid and  a.active=1 and n.namedetailid=".$this->namedetailid);
	...
	public function insert()
	{
		...
		$query = "insert into namedetail(namedetailid,namecategoryid,name_unicode,name_eng,cruserid) 
		values ($namedetailid,$this->namecategoryid,'$this->name_unicode','$this->name_eng',".$_SESSION["usersid"].")";
	...
	public function display()
	{
		...
		if ($cond!='')
		{
			$query = 'select namedetailid,name_unicode,name_eng from namedetail n where   namecategoryid='.$this->namecategoryid.' and '.$cond;
			$result = oci_parse($this->connection, $query);
			$r = oci_execute($result);
			return $result;
		}
		...
		{
			$query = 'select namedetailid,name_unicode,name_eng from namedetail n where   namecategoryid='.$this->namecategoryid;
			$result = oci_parse($this->connection, $query);
			$r = oci_execute($result);
			return $result;
		}
    ...
    {
        $query = "select n.* from namecategory n where  namecategoryid=".$namecategoryid;
