    ...
    {	
        ...
        function printpageheader(&$pdf,&$liney)
        {
            ...
            while ($row = oci_fetch_array($result,OCI_ASSOC+OCI_RETURN_NULLS))
            {
                ...
                $pdf->multicell(25,20,$row['FIRSTINSTALLMENTPERHEAD']/100000,0,'R',false,1,70,$liney,true,0,false,true,10);
                $pdf->multicell(25,20,$row['SECONDINSTALLMENTPERHEAD']/100000,0,'R',false,1,100,$liney,true,0,false,true,10);
                $pdf->multicell(25,20,$row['THIRDINSTALLEMENTPERHEAD']/100000,0,'R',false,1,125,$liney,true,0,false,true,10);
                $totaladv=$row['FIRSTINSTALLMENTPERHEAD']+$row['SECONDINSTALLMENTPERHEAD']+$row['THIRDINSTALLEMENTPERHEAD'];
                $pdf->multicell(25,20,$totaladv/100000,0,'R',false,1,150,$liney,true,0,false,true,10);
