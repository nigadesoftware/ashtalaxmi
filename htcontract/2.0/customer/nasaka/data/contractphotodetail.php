...
<body>
  	 <nav "w3-container">
            <ul class="navbar">
                ...
                <?php
                    ...
                    echo '<li><a class="navbar" href="../data/contractphotodetail_list.php?contractid='.fnEncrypt($contractid_de).'&contractreferencecategoryid='.$contractreferencecategoryid_en.'&contractreferencedetailid='.$contractreferencedetailid_en.'&flag='.fnEncrypt('Display').'">Add/Display Contract Photo Detail List</a></br>';
    ...
    <article class="w3-container">
	        ...
	        <?php
                ...
                {
                    $query = "select f.* from contractphotodetail f where f.active=1 and f.contractid = ".$contractid_de." and f.contractreferencecategoryid=".$contractreferencecategoryid_de." and f.contractreferencedetailid is null";
                }
                else
                {
                ...
                if ($row = oci_fetch_array($result,OCI_ASSOC+OCI_RETURN_NULLS))
                {
                    ...
                    //}
                        ...
                        echo '<img src="data:image/jpeg;base64,'.base64_encode($row['PHOTO']->load()).'" width="100px" height="100px"/>';
