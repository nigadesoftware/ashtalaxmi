<?php
    ...
    include("../api_report/harcontractor_report.php");
	...
	$pdf->SetSubject('Harvesting Contractor');
	$pdf->SetKeywords('HRCTLST_000.MR');
    ...
    $pdf->AddPage();
	$liney=20;
	$isadvance = $_POST['isadvance'];
    $harcontractor_report1 = new harcontractor_report($connection,$installment_de);
	$harcontractor_report1->isadvance = $isadvance;
	$harcontractor_report1->maxlines=150;
	$harcontractor_report1->reportheader($pdf,$liney);
	$harcontractor_report1->printpageheader($pdf,$liney);
	$harcontractor_report1->detail($pdf,$liney);
    $pdf->lastPage();
    ob_end_clean();
    $pdf->Output('harcontractor_000.pdf', 'I');
?>