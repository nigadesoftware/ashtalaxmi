<?php
    ...
    if (isset($_GET['contractwitnessdetailid']))
    {
        $contractwitnessdetailid_de = fnDecrypt($_GET['contractwitnessdetailid']);
    }
    if ($servicecontractorcategoryid_de == 845689712)
    {
        $iscultivator = 2;
...
<html>
    ...
    <body>
        <nav "w3-container">
            <ul class="navbar">
                ...
                <?php
                    ...
                    echo '<li><a class="navbar" href="../data/contractwitnessdetail_list.php?contractid='.fnEncrypt($contractid_de).'&flag='.fnEncrypt('Display').'">Add/Display Contract Harvester Detail List</a></br>';
        ...
        <article class="w3-container">
            ...
            <?php
                $query = "select f.* from contractwitnessdetail f where f.active=1 and f.contractid = ".$contractid_de." and f.contractwitnessdetailid=".$contractwitnessdetailid_de;
                //echo $query;
                ...
                if ($row = oci_fetch_array($result,OCI_ASSOC+OCI_RETURN_NULLS))
                {
                    ...
                    //if ($flag_de == 'Display')
                    //{
                        echo '<form method="post" action="../api_action/contractwitnessdetail_action.php">';
                    //}
                        echo '<table border="0" >';
                        ...
                        {
                            echo '<tr>';
                            echo '<td><label for="name_unicode">witness</label></td>';
                            echo '</tr>';
                        }
                        else
                        {
                            echo '<tr>';
                            echo '<td><label for="name_unicode">वारसदार</label></td>';
                            echo '</tr>';
                        }
                        echo '<tr>';
                        echo '<td><input type="text" style="font-size:12pt;height:30px" name="name_unicode" id="name_unicode" value="'.$row['NAME_UNICODE'].'" STYLE="WIDTH:300PX"></td>';
                        ...
                        echo '<td><input type="hidden" style="font-size:12pt;height:30px" name="contractwitnessdetailid" id="contractwitnessdetailid" style="width:300px" value ="'.$row['CONTRACTWITNESSDETAILID'].'"></td>';
                        echo '</tr>';
                ...
                else
                {
                    ...
                    {
                        echo '<tr>';
                        echo '<td><label for="name_unicode">साक्षीदार</label></td>';
                        echo '</tr>';
                    }
                    echo '<tr>';
                    echo '<td><input type="text" style="font-size:12pt;height:30px" name="name_unicode" id="name_unicode" style="width:300px"></td>';
                    echo '<td><label for="name_unicode">*</label></td>';
                    echo '</tr>';
