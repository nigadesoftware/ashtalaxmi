<?php
    ...
    require("../api_oracle/contractdocumentdetail_db_oracle.php");
    ...
    if ($flag=='All')
    {
        ...
        $ret = $contractdocumentdetail1->insertall($contractid_de);
        if ($ret==1)
        {
        ...
        header("Location: ../data/contractdocumentdetail_list.php?contractid='.$contractid_en.'");
    }
?>
<!DOCTYPE html>
<html>
