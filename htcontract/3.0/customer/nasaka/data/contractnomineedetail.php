<?php
    ...
    if (isset($_GET['contractnomineedetailid']))
    {
        $contractnomineedetailid_de = fnDecrypt($_GET['contractnomineedetailid']);
    }
...
<html>
    ...
    <body>
        <nav "w3-container">
            <ul class="navbar">
                ...
                <?php
                    ...
                    echo '<li><a class="navbar" href="../data/contractnomineedetail_list.php?contractid='.fnEncrypt($contractid_de).'&flag='.fnEncrypt('Display').'">Add/Display Contract Harvester Detail List</a></br>';
        ...
        <article class="w3-container">
            ...
            <?php
                $query = "select f.* from contractnomineedetail f where f.active=1 and f.contractid = ".$contractid_de." and f.contractnomineedetailid=".$contractnomineedetailid_de;
                //echo $query;
                ...
                if ($row = oci_fetch_array($result,OCI_ASSOC+OCI_RETURN_NULLS))
                {
                    ...
                    //if ($flag_de == 'Display')
                    //{
                        echo '<form method="post" action="../api_action/contractnomineedetail_action.php">';
                    //}
                        echo '<table border="0" >';
                        ...
                        {
                            echo '<tr>';
                            echo '<td><label for="name_unicode">Nominee</label></td>';
                            echo '</tr>';
                        }
                        else
                        {
                        ...
                        echo '<td><input type="hidden" style="font-size:12pt;height:30px" name="contractnomineedetailid" id="contractnomineedetailid" style="width:300px" value ="'.$row['CONTRACTNOMINEEDETAILID'].'"></td>';
                        echo '</tr>';
