<?php
    ...
    {	
        ...
        function exportcsv($installment)
        {
            $filename='harcontadvance.csv';
            $fp1=fopen('php://memory', 'w'); 
            $query1 = "select t.contractorzonecode,c.contractorzonename_unicode,t.seasonid,substr(s.refcode,1,1) as type,t.servicecontractorid,s.NAME_UNICODE,s.refcode
                ,sum(doki) as doki
                ,sum(truck) as truck
                ,sum(bulluck) as bulluck
                ,sum(tractor) as tractor
                ...
                ,sum(koyata) as koyata
                from (
                select t.seasonid,contractorzonecode
                ,d.servicecontractorid
                ,case when d.transportationuptovehicleid=248769412 then d.noofvehicles else 0 end doki
                ,case when d.transportationuptovehicleid=248769559 then d.noofvehicles else 0 end truck
                ,case when d.transportationuptovehicleid=125478451 then d.noofvehicles else 0 end bulluck
                ...
                and isadvance=1 
                and t.seasonid=".$_SESSION['finalreportperiodid']."
                )t,servicecontractor s,contractorzone c
                where t.servicecontractorid=s.SERVICECONTRACTORID
                and t.contractorzonecode=c.contractorzonecode
                group by t.contractorzonecode,c.contractorzonename_unicode,t.seasonid,substr(s.refcode,1,1),t.servicecontractorid,s.NAME_UNICODE,s.refcode
                order by t.contractorzonecode,c.contractorzonename_unicode,substr(s.refcode,1,1),s.refcode,s.NAME_UNICODE";
                if ($installment==0)
                    fputcsv($fp1, array('झोन','अ नं.','कोड नं.','कंत्राटदाराचे नाव','बैल टायर','ट्रॅक्टर टायर','वाहन टोळी','डोकी सेंटर','एकूण कोयता संख्या','पहिला अॅड. हप्ता','दुसरा अॅड. हप्ता','तिसरा अॅड. हप्ता','एकूण रक्कम'));    
                elseif ($installment==1)
                    fputcsv($fp1, array('झोन','अ नं.','कोड नं.','कंत्राटदाराचे नाव','बैल टायर','ट्रॅक्टर टायर','वाहन टोळी','डोकी सेंटर','एकूण कोयता संख्या','पहिला अॅड. हप्ता'));    
                elseif ($installment==2)
                    fputcsv($fp1, array('झोन','अ नं.','कोड नं.','कंत्राटदाराचे नाव','बैल टायर','ट्रॅक्टर टायर','वाहन टोळी','डोकी सेंटर','एकूण कोयता संख्या','दुसरा अॅड. हप्ता'));                        
                elseif ($installment==3)
                    fputcsv($fp1, array('झोन','अ नं.','कोड नं.','कंत्राटदाराचे नाव','बैल टायर','ट्रॅक्टर टायर','वाहन टोळी','डोकी सेंटर','एकूण कोयता संख्या','तिसरा अॅड. हप्ता'));    
                ...
                {
                    if ($installment==0)
                        fputcsv($fp1, array($row1['CONTRACTORZONENAME_UNICODE'],$srno,$row1['REFCODE'],$row1['NAME_UNICODE']
                        ,$row1['BULLUCK'],$row1['TRACTOR'],$row1['TRUCK'],$row1['DOKI']
                        ,$row1['KOYATA']
                        ,$row1['FIRSTINSTALLMENT'],$row1['SECONDINSTALLMENT']
                        ,$row1['THIRDINSTALLMENT'],$row1['FIRSTINSTALLMENT']+$row1['SECONDINSTALLMENT']+$row1['THIRDINSTALLMENT']));        
                    elseif ($installment==1)
                        fputcsv($fp1, array($row1['CONTRACTORZONENAME_UNICODE'],$srno,$row1['REFCODE'],$row1['NAME_UNICODE']
                        ,$row1['BULLUCK'],$row1['TRACTOR'],$row1['TRUCK'],$row1['DOKI']
                        ,$row1['KOYATA']
                        ,$row1['FIRSTINSTALLMENT']));        
                    elseif ($installment==2)
                        fputcsv($fp1, array($row1['CONTRACTORZONENAME_UNICODE'],$srno,$row1['REFCODE'],$row1['NAME_UNICODE']
                        ,$row1['BULLUCK'],$row1['TRACTOR'],$row1['TRUCK'],$row1['DOKI']
                        ,$row1['KOYATA']
                        ,$row1['SECONDINSTALLMENT']
                        ));        
                    elseif ($installment==3)
                        fputcsv($fp1, array($row1['CONTRACTORZONENAME_UNICODE'],$srno,$row1['REFCODE'],$row1['NAME_UNICODE']
                        ,$row1['BULLUCK'],$row1['TRACTOR'],$row1['TRUCK'],$row1['DOKI']
                        ,$row1['KOYATA']
                        ,$row1['THIRDINSTALLMENT']));        
                    $srno++;
                }
