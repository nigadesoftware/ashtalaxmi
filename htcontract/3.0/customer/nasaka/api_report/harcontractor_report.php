<?php
    ...
    {	
        ...
        function reportheader(&$pdf,&$liney)
        {
            ...
            if ($this->isadvance==0)
            {
                $pdf->multicell(100,10,'अॅॅॅडव्हान्स नाही कंत्राटदार यादी',0,'L',false,1,80,$liney,true,0,false,true,10);
            }
            elseif ($this->isadvance==1)
            {
                $pdf->multicell(100,10,'अॅॅॅडव्हान्स कंत्राटदार यादी',0,'L',false,1,80,$liney,true,0,false,true,10);
            }
            elseif ($this->isadvance==2)
            {
                $pdf->multicell(100,10,'अॅॅॅडव्हान्स नाही कमिशन आहे कंत्राटदार यादी',0,'L',false,1,70,$liney,true,0,false,true,10);
            }
            $liney = $liney+7;
            $pdf->multicell(100,10,'हंगाम -'.$_SESSION['yearperiodcode'],0,'L',false,1,90,$liney,true,0,false,true,10);
        }
        function printpageheader(&$pdf,&$liney)
        {
            ...
            $pdf->multicell(30,20,'एकूण कोयता संख्या',0,'L',false,1,170,$liney,true,0,false,true,10);
            $liney = $liney+5;
            $pdf->multicell(20,10,'डा.',0,'L',false,1,110,$liney,true,0,false,true,10);
            $pdf->multicell(20,10,'ट्रॅक्टर ',0,'L',false,1,123,$liney,true,0,false,true,10);
            $pdf->multicell(20,20,'वाहन',0,'L',false,1,140,$liney,true,0,false,true,10);
            $pdf->multicell(20,20,'डोके ',0,'L',false,1,155,$liney,true,0,false,true,10);
            $liney = $liney+5;
            $pdf->multicell(20,10,'का.',0,'L',false,1,110,$liney,true,0,false,true,10);
            $pdf->multicell(20,10,'टायर',0,'L',false,1,123,$liney,true,0,false,true,10);
            $pdf->multicell(20,20,'टोळी',0,'L',false,1,140,$liney,true,0,false,true,10);
            $pdf->multicell(20,20,'सेंटर',0,'L',false,1,155,$liney,true,0,false,true,10);
            $liney = $liney+5;
            $pdf->line(10,$liney,290,$liney);
        ...
        function detail(&$pdf,&$liney)
        {
            ...
            and c.isadvance=".$this->isadvance." 
