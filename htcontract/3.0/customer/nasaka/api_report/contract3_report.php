...
{	
	...
	function printpageheader(&$pdf,&$liney,$contractid)
    {
		...
		if ($contract1->fetch($contractid))
		{
			...
			{
				$subject = 'विषय - सन '.$contract1->seasonname_unicode.' गळीत हंगामा करिता ऊस तोडणी यंत्राने ऊस तोड वहातुक करार.';
				$pdf->multicell(180,10,$subject,0,'L',false,1,30,$liney,true,0,false,true,10);
				$liney = $liney+7;
			...
			elseif ($contract1->contractcategoryid == 654784125)
			{
				...
				कंत्राटदार विभाग <u>'.$contract1->contractorzonename_unicode.'</u> विनंतीपूर्वक अर्ज करतो की, गळीत हंगाम 
				<u>सन '.$contract1->seasonname_unicode.'</u> चे
				 करिता ऊस तोडणी यंत्रामार्फत आपले कारखान्याकडे ऊस तोडीचे व वाहतुकीचे काम करण्यास तयार आहे.
