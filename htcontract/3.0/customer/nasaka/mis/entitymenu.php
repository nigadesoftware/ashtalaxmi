...
<head>
	...
	<body>
				...
				<?php
					...
					elseif ($_SESSION["responsibilitycode"] == 658741245893258)
					{
						...
						echo '<ul class="servicebar">';
							...
							//echo '<li><a class="servicebar" href="../mis/usermenu.php">User Menu</a><br/>';
							//echo '<li><a class="servicebar" href="../data/servicecontractor.php">Service Contractor</a>';
							echo '<li><a class="servicebar" href="../../../../../agriculture//data/masterbase.php?namecategoryid='.$namecategoryid_en.'">Transportation Vehicle</a>';
							$namecategoryid_en = fnEncrypt(398541725);
							echo '<li><a class="servicebar" href="../data/masterbase.php?namecategoryid='.$namecategoryid_en.'">Transportation Vehicle</a>';
							$namecategoryid_en = fnEncrypt(845125632);
							echo '<li><a class="servicebar" href="../data/masterbase.php?namecategoryid='.$namecategoryid_en.'">HT Contract Related Service</a>';
					...
					elseif ($_SESSION["responsibilitycode"] == 475124562358965)
					{
						...
						//echo '<li><a class="servicebar" href="../mis/usermenu.php">User Menu</a><br/>';
						//echo '<li><a class="servicebar" href="../data/servicecontractor.php">Service Contractor</a>';
						echo '<li><a class="servicebar" href="../../../../../agriculture/1.0/customer/kadwa/ip_view/contractor.php">Contractor</a>';
						echo '<li><a class="servicebar" href="../../../../../agriculture/1.0/customer/kadwa/ip_view/bank.php">Bank</a>';
						echo '<li><a class="servicebar" href="../../../../../agriculture/data/masterbase.php?namecategoryid='.$namecategoryid_en.'">Transportation Vehicle</a>';
						echo '<li><a class="servicebar" href="../data/contract.php">Contract</a>';
						echo '<li><a class="servicebar" href="../data/contractmapping.php">Contract Mapping</a>';
						echo '<li><a class="servicebar" href="../data/harvestinglabouradvancerate.php">Harvesting Labour Advance Rate</a>';
						...
						$installment_en = fnEncrypt('0');
						$export_en = fnEncrypt('0');
						echo '<li><a class="servicebar" href="../view/harcontadv_view.php?installment='.$installment_en.'&export='.$export_en.'">Harvesting Labour Advance Report(All Installement)</a>';
						$installment_en = fnEncrypt('1');
						echo '<li><a class="servicebar" href="../view/harcontadv_view.php?installment='.$installment_en.'&export='.$export_en.'">Harvesting Labour Advance Report(First Installement)</a>';
						$installment_en = fnEncrypt('2');
						echo '<li><a class="servicebar" href="../view/harcontadv_view.php?installment='.$installment_en.'&export='.$export_en.'">Harvesting Labour Advance Report(Second Installement)</a>';
						$installment_en = fnEncrypt('3');
						echo '<li><a class="servicebar" href="../view/harcontadv_view.php?installment='.$installment_en.'&export='.$export_en.'">Harvesting Labour Advance Report(Third Installement)</a>';
						...
						$installment_en = fnEncrypt('0');
						$export_en = fnEncrypt('1');
						echo '<li><a class="servicebar" href="../view/harcontadv_view.php?installment='.$installment_en.'&export='.$export_en.'">Export Harvesting Labour Advance Report(All Installement)</a>';
						$installment_en = fnEncrypt('1');
						$export_en = fnEncrypt('1');
						echo '<li><a class="servicebar" href="../view/harcontadv_view.php?installment='.$installment_en.'&export='.$export_en.'">Export Harvesting Labour Advance Report(First Installement)</a>';
						$installment_en = fnEncrypt('2');
						$export_en = fnEncrypt('1');
						echo '<li><a class="servicebar" href="../view/harcontadv_view.php?installment='.$installment_en.'&export='.$export_en.'">Export Harvesting Labour Advance Report(Second Installement)</a>';
						$installment_en = fnEncrypt('3');
						$export_en = fnEncrypt('1');
						echo '<li><a class="servicebar" href="../view/harcontadv_view.php?installment='.$installment_en.'&export='.$export_en.'">Export Harvesting Labour Advance Report(Third Installement)</a>';
						echo '<li><a class="servicebar" href="../mis/selectresponsibility.php">Switch Responsibility</a><br/>';
						echo '<li><a class="servicebar" href="../../../../../sqlproc/logout.php">Log Out</a><br/>';
						echo '</ul>';
						echo "</p>";
			...
			<footer>
				<div class="copyright">This is developed and maintained by Nigade Software Technologies (opc) Private Limited. Copyright &copy;2020 Nigade Software Technologies (opc) Private Limited</div>
			</footer>
	</body>
</html>