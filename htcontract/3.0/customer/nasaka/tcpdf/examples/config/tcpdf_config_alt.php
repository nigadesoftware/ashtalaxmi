 ...
 */
define ('PDF_HEADER_LOGO', 'swapp_namelogo.png');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'nigadeERP');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Nigade Software Technologies (opc) Private Limited');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Swapp');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "by Nigade Software Technologies (opc) Private Limited\nwww.swapp.co.in");
