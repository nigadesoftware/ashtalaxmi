...
class TCPDF {
	...
	public function Header() {
		if ($this->header_xobjid === false) {
			...
			$this->SetLineStyle(array('width' => 0.50 / $this->k, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => array(0,0,0)));
		...
		//page number on the left top
		$cur_y = $this->w;//- $this->original_rMargin;
		$w_page = '';
		...
		$this->SetY(0);
		$this->SetX(0);
		$this->Cell(240, 20, $pagenumtxt, '', 0, 'R');
	}
	...
	public function Footer() {
		...
		$this->SetLineStyle(array('width' => $line_width, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => array(50,50,50)));
	...
	//Swapp Method to get the next or previous character
	protected function getchar($arr,$curind,$nxtpreno)
	{
		$cnt = count($arr);
		if (($curind+$nxtpreno)>=$cnt or ($curind+$nxtpreno)<0)
		{
			return 0x0950;
		}
		else
		{
			return $arr[$curind+$nxtpreno];
		}
	} 
	/**
			...
			if ($this->isunicode) {
				if (($this->CurrentFont['type'] == 'core') OR ($this->CurrentFont['type'] == 'TrueType') OR ($this->CurrentFont['type'] == 'Type1')) {
					...
					if (defined('K_THAI_TOPCHARS') AND (K_THAI_TOPCHARS == true)) {
						...
						//modified for half characters of Devanagari
						//
						//if ($this->CurrentFont['fontkey'] == 'siddhanta')
						//{
						$numchars = count($unicode);
						$output = array();
						$viram = 0x094d;
						...
						{
							//for Rs
							if ($unicode[$i] == 0x0052 and $unicode[$i+1] == 0x0073)
							{
								$output[] = $this->replaceChar($unicode[$i], 0x20b9);
								$i++;
							}
							//for digit 0
							elseif ($unicode[$i] == 0x0030)
							{
								$output[] = $this->replaceChar($unicode[$i], 0x0966);
							}
							//for digit 1
							elseif ($unicode[$i] == 0x0031)
							{
								$output[] = $this->replaceChar($unicode[$i], 0x0967);
							}
							//for digit 2
							elseif ($unicode[$i] == 0x0032)
							{
								$output[] = $this->replaceChar($unicode[$i], 0x0968);
							}
							//for digit 3
							elseif ($unicode[$i] == 0x0033)
							{
								$output[] = $this->replaceChar($unicode[$i], 0x0969);
							}
							//for digit 4
							elseif ($unicode[$i] == 0x0034)
							{
								$output[] = $this->replaceChar($unicode[$i], 0x096a);
							}
							//for digit 5
							elseif ($unicode[$i] == 0x0035)
							{
								$output[] = $this->replaceChar($unicode[$i], 0x096b);
							}
							//for digit 6
							elseif ($unicode[$i] == 0x0036)
							{
								$output[] = $this->replaceChar($unicode[$i], 0x096c);
							}
							//for digit 7
							elseif ($unicode[$i] == 0x0037)
							{
								$output[] = $this->replaceChar($unicode[$i], 0x096d);
							}
							//for digit 8
							elseif ($unicode[$i] == 0x0038)
							{
								$output[] = $this->replaceChar($unicode[$i], 0x096e);
							}
							//for digit 9
							elseif ($unicode[$i] == 0x0039)
							{
								$output[] = $this->replaceChar($unicode[$i], 0x096f);
							}
							//for Ka
							elseif ($unicode[$i] == 0x0915)
							{
								//for viram and Ra
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									if ($this->getchar($unicode,$i,3) == 0x093f)
									{
										$output[] = 0x093f;
									}
									$output[] = $this->replaceChar($unicode[$i], 0xf363);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
										$i++;
									}
								}
								//for viram and sha (shatkon) and pahili velanti
								elseif ($this->getchar($unicode,$i,1) == $viram and $this->getchar($unicode,$i,2) ==0x0937 and $this->getchar($unicode,$i,3) == 0x093f)
								{
									$output[] = $this->replaceChar($unicode[$i], 0x093f);
									$i++;
									$output[] = $this->replaceChar($unicode[$i], 0xf337);
									$i++;
									$i++;
								}
								//for viram and sha (shatkon)
								elseif ($this->getchar($unicode,$i,1) == $viram and $this->getchar($unicode,$i,2) == 0x0937 and $this->getchar($unicode,$i,3) != $viram)
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf337);
									$i++;
									$i++;
								}
								//for viram and sha (shatkon) and viram Ksh (Kshatriya)
								elseif ($this->getchar($unicode,$i,1) == $viram and $this->getchar($unicode,$i,2) == 0x0937 and $this->getchar($unicode,$i,3) == $viram)
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf35d);
									$i++;
									$i++;
									$i++;
								}
								elseif ($this->getchar($unicode,$i,1) == $viram)
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf33a);
									$i++;
								}
								else
								{
							...
							elseif ($unicode[$i] == 0x0916)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf364);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf33b);
									$i++;
								}
								else
								{
							...
							elseif ($unicode[$i] == 0x0917)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf365);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf33c);
									$i++;
								}
								else
								{
							...
							elseif ($unicode[$i] == 0x0918)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf366);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf33d);
									$i++;
								}
								else
								{
							...
							elseif ($unicode[$i] == 0x091a)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf367);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								//for viram and Chh
								elseif ($this->getchar($unicode,$i,1) == $viram and $this->getchar($unicode,$i,2) == 0x091b and $this->getchar($unicode,$i,3) == 0x093f)
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf320);
									$i++;
									$output[] = $this->replaceChar($unicode[$i], 0xf33e);
									$i++;
									$output[] = $this->replaceChar($unicode[$i], 0x091b);
									$i++;
								}
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
							...
							elseif ($unicode[$i] == 0x091c)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf368);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								//for viram and Nya
								elseif ($this->getchar($unicode,$i,1) == $viram and $this->getchar($unicode,$i,2) == 0x091e and $this->getchar($unicode,$i,1) != $viram)
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf339);
									$i++;
									$i++;
								}
								//for viram and Nya and viram (Dny - Dnyaneshwar) and kana
								elseif ($this->getchar($unicode,$i,1) == $viram and $this->getchar($unicode,$i,2) == 0x091e and $this->getchar($unicode,$i,1) == $viram and $this->getchar($unicode,$i,3)==0x093e)
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf360);
									$output[] = 0x093e;
									$output[] = 0x093e;
									$i++;
									$i++;
								...
								//for viram and Nya and viram (Dny - Dnyaneshwar)
								elseif ($this->getchar($unicode,$i,1) == $viram and $this->getchar($unicode,$i,2) == 0x091e and $this->getchar($unicode,$i,1) == $viram)
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf360);
									$output[] = 0x093e;
								...
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf33f);
									$i++;
								}
								else
								{
							...
							elseif ($unicode[$i] == 0x091d)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf369);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf340);
									$i++;
								}
								else
								{
							...
							elseif ($unicode[$i] == 0x091f)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									$output[] = $unicode[$i];
									$i++;
									$output[] = $this->replaceChar($unicode[$i], 0x1cd9);
									$i++;
								}
								else
								{
							...
							elseif ($unicode[$i] == 0x0923)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf36c);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf344);
									$i++;
								}
								else
								{
							...
							elseif ($unicode[$i] == 0x0924)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf36e);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf346);
									$i++;
								}
								else
								{
							...
							elseif ($unicode[$i] == 0x0925)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf36f);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								elseif ($this->getchar($unicode,$i,1) == $viram)
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf347);
									$i++;
								}
								else
								{
							...
							elseif ($unicode[$i] == 0x0926)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf370);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
							...
							elseif ($unicode[$i] == 0x0927)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf372);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf349);
									$i++;
								}
								else
								{
							...
							elseif ($unicode[$i] == 0x0928)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf373);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf34a);
									$i++;
								}
								else
								{
							...
							elseif ($unicode[$i] == 0x092A)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf374);
									$i++;
									$this->replaceChar($unicode[$i], 0x0fd7);
									$i++;
									$this->replaceChar($unicode[$i], 0x0fd7);
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf34b);
									$i++;
								}
								else
								{
							...
							elseif ($unicode[$i] == 0x092B)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf375);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf34c);
									$i++;
								}
								else
								{
							...
							elseif ($unicode[$i] == 0x092C)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf376);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf34d);
									$i++;
								}
								else
								{
							...
							elseif ($unicode[$i] == 0x092D)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf378);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf34f);
									$i++;
								}
								else
								{
							...
							elseif ($unicode[$i] == 0x092E)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf379);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf350);
									$i++;
								}
								else
								{
							...
							elseif ($unicode[$i] == 0x092F)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf37A);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf351);
									$i++;
								}
								else
								{
							...
							{
								//for viram and Yaa
								if ($this->getchar($unicode,$i,1) == $viram && $this->getchar($unicode,$i,2) == 0x092f && $this->getchar($unicode,$i,3) == 0x093e)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf352);
									$i++;
								}
								//for viram and Ya
								elseif ($this->getchar($unicode,$i,1) == $viram && $this->getchar($unicode,$i,2) == 0x092f)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0x092f);
									$i++;
									$output[] = $this->replaceChar($unicode[$i], 0xf306);
									$i++;
								}
								//for viram and Ha
								elseif ($this->getchar($unicode,$i,1) == $viram && $this->getchar($unicode,$i,2) == 0x0939)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf352);
									$i++;
									$output[] = $this->replaceChar($unicode[$i], 0x0939);
									$i++;
								}
								//for viram and kana
								elseif ($this->getchar($unicode,$i,1) == $viram && $this->getchar($unicode,$i,3) == 0x093e)	
								{
									$output[] = $this->replaceChar($unicode[$i], $this->getchar($unicode,$i,2));
									$i++;
									$output[] = $this->replaceChar($unicode[$i], 0x093e);
									$i++;
									$output[] = $this->replaceChar($unicode[$i], 0xf306);
									$i++;
								}
								//for viram and matra
								elseif ($this->getchar($unicode,$i,1) == $viram && $this->getchar($unicode,$i,3) == 0x0947)	
								{
									$output[] = $this->replaceChar($unicode[$i], $this->getchar($unicode,$i,2));
									$i++;
									$output[] = $this->replaceChar($unicode[$i], 0x0947);
									$i++;
									$output[] = $this->replaceChar($unicode[$i], 0xf306);
									$i++;
								}
								//for viram and dusari velanti
								elseif ($this->getchar($unicode,$i,1) == $viram && $this->getchar($unicode,$i,3) == 0x0940)	
								{
									$output[] = $this->replaceChar($unicode[$i], $this->getchar($unicode,$i,2));
									$i++;
									$output[] = $this->replaceChar($unicode[$i], 0x0940);
									$i++;
									$output[] = $this->replaceChar($unicode[$i], 0xf306);
									$i++;
								}
								//for viram and without kana
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
									$output[] = $this->replaceChar($unicode[$i], $this->getchar($unicode,$i,2));
									$i++;
								...
								//for pahila ukara
								elseif ($this->getchar($unicode,$i,1) == 0x0941)	
								{
									$output[] = $this->replaceChar($unicode[$i+1], 0xF554);
									$i++;
								}
								//for dusara ukara
								elseif ($this->getchar($unicode,$i,1) == 0x0942)	
								{
									$output[] = $this->replaceChar($unicode[$i+1], 0xF555);
									$i++;
								}
								else
								{
							...
							//for pahili velanti replacement and space
							elseif ($unicode[$i] == 0x093f and $this->getchar($unicode,$i,-2) == 0x0020)		
							{
								$ch1=$this->getchar($unicode,$i,-1);
								$output[count($output)-1] = $this->replaceChar($unicode[$i-1], 0x093f);
								$output[] =  $this->replaceChar($unicode[$i], $ch1);
							}
							//for pahili velanti replacement and not Ra
							elseif ($unicode[$i] == 0x093f and $this->getchar($unicode,$i,-1) != 0xf306 and $this->getchar($unicode,$i,-3) != 0x0930)		
							{
								$ch1=$this->getchar($unicode,$i,-1);
								$output[count($output)-1] = $this->replaceChar($unicode[$i-1], 0x093f);
								$output[] =  $this->replaceChar($unicode[$i], $ch1);
							}
							//for pahili velanti replacement and Ra and previous viram
							elseif ($unicode[$i] == 0x093f and $this->getchar($unicode,$i,-3) == 0x0930 and $this->getchar($unicode,$i,-2) != 0x093e  and $this->getchar($unicode,$i,-4) == $viram)		
							{
								$ch1=$this->getchar($unicode,$i,-1);
								$output[count($output)-1] = $this->replaceChar($unicode[$i-1], 0x093f);
								$output[] =  $this->replaceChar($unicode[$i], $ch1);
							}
							//for pahili velanti replacement and Ra
							elseif ($unicode[$i] == 0x093f and $this->getchar($unicode,$i,-3) == 0x0930 and $this->getchar($unicode,$i,-2) != 0x093e  and $this->getchar($unicode,$i,-4) != $viram)		
							{
								$ch1 = $this->getchar($unicode,$i,-1);
								$output[count($output)-2] = $this->replaceChar($unicode[$i-2], 0x093f);
								$output[count($output)-1] = $this->replaceChar($unicode[$i-1], $ch1);
								$output[] = $this->replaceChar($unicode[$i], 0xf306);
							}
							//for pahili velanti replacement and Ra with kana
							elseif ($unicode[$i] == 0x093f and $this->getchar($unicode,$i,-3) == 0x0930 and $this->getchar($unicode,$i,-2) == 0x093e)		
							{
								$ch1 = $this->getchar($unicode,$i,-1);
								$output[count($output)-3] = $this->replaceChar($unicode[$i-3], 0x0930);
								$output[count($output)-2] = $this->replaceChar($unicode[$i-2], 0x093e);
								$output[count($output)-1] = $this->replaceChar($unicode[$i-1], 0x093f);
								$output[count($output)] = $this->replaceChar($unicode[$i], $ch1);
								//$output[] = $this->replaceChar($unicode[$i], 0xf306);
								//$i++;
							}
							//for La
							elseif ($unicode[$i] == 0x0932)
							{
								//for viram and Ra
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf37b);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf353);
									$i++;
								}
								else
								{
							...
							//for La (baal)
							elseif ($unicode[$i] == 0x0933 or $unicode[$i] == 0x0934)
							{
								//for viram
								if ($this->getchar($unicode,$i,1) == $viram)	
								{
									if ($this->getchar($unicode,$i,3) == 0x093f)
									{
										$output[] = 0x093f;
									}
									$output[] = $this->replaceChar($unicode[$i], 0xf355);
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
										$i++;
							...
							elseif ($unicode[$i] == 0x0935)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf37c);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf356);
									$i++;
								}
								else
								{
							...
							elseif ($unicode[$i] == 0x0936)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf37d);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf357);
									$i++;
								}
								else
								{
							...
							elseif ($unicode[$i] == 0x0937)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf37e);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf35a);
									$i++;
								}
								else
								{
							...
							elseif ($unicode[$i] == 0x0938)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf37f);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								elseif ($this->getchar($unicode,$i,1) == $viram and $this->getchar($unicode,$i,3) == 0x093f)	
								{
									$output[] = 0x093f;
									$output[] = $this->replaceChar($unicode[$i], 0xf35b);
									$output[] = $this->getchar($unicode,$i,2);
									$i++;
									$i++;
									$i++;
								}
							...
							elseif ($unicode[$i] == 0x0939)
							{
								...
								if ($this->getchar($unicode,$i,1) == $viram and ($this->getchar($unicode,$i,2) == $ra or $this->getchar($unicode,$i,2) == $ra1))
								{
									...
									$output[] = $this->replaceChar($unicode[$i], 0xf380);
									$i++;
									$i++;
									if ($this->getchar($unicode,$i,1) == 0x093f)
									{
								...
								elseif ($this->getchar($unicode,$i,1) == $viram)	
								{
									$output[] = $this->replaceChar($unicode[$i], 0xf35c);
									$i++;
								}
								else
								{
