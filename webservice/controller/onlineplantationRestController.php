<?php
	require_once("..\handler\onlineplantationRestHandler.php");
	$view = "";
	$seasonyear = "";
	$sectioncode = "";
	$offset=1;
	...
	*/
	...
	switch ($view)
	{
		case 'onlineplantation':
		{
			...
			$plantationRestHandler->getonlineplantationrecord($seasonyear,$sectioncode,$offset,$rowsperpage,$view);
			break;
		}
		case 'totalrecords':
		{
			$plantationRestHandler = new onlineplantationRestHandler();
			$plantationRestHandler->gettotalrecords($seasonyear,$sectioncode,$view);
			break;
		}
		case 'sectvillhan':
		{
			$plantationRestHandler = new onlineplantationRestHandler();
			$plantationRestHandler->getsectvillhanrecord($seasonyear,$sectioncode,$view);
			break;
		}
		case 'secthan':
		{
		...
		{
			$plantationRestHandler = new onlineplantationRestHandler();
			$plantationRestHandler->getsectionlist($view);
			break;
		}
		case 'seasonyearlist':
		{
