<?php
	$str="../handler/fieldslipRestHandler.php";
	require_once($str);
	$view = "";
	$slipboyuserid = "";
	...
	*/
	...
	switch ($view)
	{
		case 'upload':
		{
			$fieldslipRestHandler1 = new fieldslipRestHandler();
			$statusCode=$fieldslipRestHandler1->postfieldslip($view,$slipboyuserid,$input);
			header("Access-Control-Allow-Origin: *");
			header("Content-Type: application/json; charset=UTF-8");
			header("Access-Control-Allow-Methods: POST");
			header("Access-Control-Max-Age: 3600");
