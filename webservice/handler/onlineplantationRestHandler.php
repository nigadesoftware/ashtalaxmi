...
require_once("..\data\onlineplantation.php");
require_once("..\info\connection.php");		
class onlineplantationRestHandler extends SimpleRest 
{
	function getonlineplantationrecord($seasonyear,$sectioncode,$offset,$rowsperpage,$view)
	{	
	...
	function gettotalrecords($seasonyear,$sectioncode,$view)
	{	
		$connection = production_connection();
		$onlineplantation1 = new onlineplantation($connection);
		$onlineplantation1->seasonyear = $seasonyear;
	...
	function getsectvillhanrecord($seasonyear,$sectioncode,$view)
	{	
		$connection = production_connection();
		$onlineplantation1 = new onlineplantation($connection);
		$onlineplantation1->seasonyear = $seasonyear;
	...
	function getsectionlist($view)
	{	
		$connection = production_connection();
		$onlineplantation1 = new onlineplantation($connection);
		if ($view == 'sectionlist')
		{
			$rawData = $onlineplantation1->getsectionlist();
		}
		if(empty($rawData))
		{
			$statusCode = 404;
