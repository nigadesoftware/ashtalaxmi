        ...
        <article class="w3-container">
            <?php
                ...
                if ($reportcode_de==32 or $reportcode_de==42)
                {
                    ...
                    echo '<td><input type="checkbox" id="exportcsvfile" name="exportcsvfile" value="2">Export Above2lac Below5lac CSV File</td>';
                    echo '<td><input type="checkbox" id="exportcsvfile" name="exportcsvfile" value="3">Export Below2lac CSV File</td>';
                    echo '<td><input type="checkbox" id="exportcsvfile" name="exportcsvfile" value="4">Export Above5lac CSV File</td>';
                    echo '</tr>';
                    echo '<tr>';
                }
                if ($reportcode_de==49)
