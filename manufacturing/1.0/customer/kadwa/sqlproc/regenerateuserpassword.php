<?php
   ...
   if ($retcode !='')
   {
   		...
   		echo '<tr>';
   		echo '<td><img src="../img/U.png" width="16px" height="31px"><a style="color:#000" class="servicebar" href="../ip_view/userresponsibility_list.php?userid='.$userid_en.'">Responsibility List</a>';
   		echo '</tr>';
   }
   else
   {
