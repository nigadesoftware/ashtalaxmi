...
class circlevillagecrushing extends reportbox
{
	...
	function pageheader()
    {
        ...
        $this->setfieldwidth(30);
        $this->textbox('गावचे नाव',$this->w,$this->x,'S','L',1,'siddhanta',10,'','','','B');        
    ...
    function group()
    {
        ...
        {
            if ($cond=="")
                $cond="c.centrecode=".$this->circlecode;
            else
                $cond=$cond." and c.centrecode=".$this->circlecode;
        }
        ...
        $group_query_1 = "select c.centrecode,v.villagecode
        ,c.centrenameuni,v.villagenameuni
        ,row_number() over(partition by c.centrecode order by v.villagecode)sr_no      
        ...
        group by c.centrecode,v.villagecode
        ,c.centrenameuni,v.villagenameuni       
        order by c.centrecode,v.villagecode
    ...
    {
        $this->circlename=$group_row_1['CENTRENAMEUNI'];
        $this->circlesummary['TONNAGE']=0;
       
        $this->setfieldwidth(30,10);
        $this->textbox('गट-'.$group_row_1['CENTRENAMEUNI'],$this->w,$this->x,'S','L',1,'siddhanta',10,'','','','B');
        $this->newrow();
    }
    ...
    function detail_1(&$group_row_1)
    {
        ...
        $this->setfieldwidth(30);
        $this->textbox($group_row_1['VILLAGECODE'],$this->w,$this->x,'S','L',1,'siddhanta',10,'','','','');
        $this->setfieldwidth(30);
        $this->textbox($group_row_1['VILLAGENAMEUNI'],$this->w,$this->x,'S','L',1,'siddhanta',10,'','','','');       
        $this->setfieldwidth(25);
        $this->textbox($group_row_1['TONNAGE'],$this->w,$this->x,'S','R',1,'siddhanta',10,'','','','');
        $this->newrow(5);
    ...
    {     
        ...
        $this->textbox('गट एकूण',$this->w,$this->x,'S','R',1,'siddhanta',11,'','','','B');
