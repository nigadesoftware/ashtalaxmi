...
class contractorbusiness extends reportbox
{
    ...
    function pageheader()
    {
        ...
        $this->setfieldwidth(20);
        $this->textbox('डिपाॅझिट',$this->w,$this->x,'S','R',1,'siddhanta',10,'','','','B');
        $this->setfieldwidth(20);
        $this->textbox('अडव्हांस',$this->w,$this->x,'S','R',1,'siddhanta',10,'','','','B');
        $this->setfieldwidth(20);
        $this->textbox('डिझेल',$this->w,$this->x,'S','R',1,'siddhanta',10,'','','','B');
        $this->setfieldwidth(20);
    ...
    function reportfooter()
    {
        ...
        //$this->textbox('ए एकंदर',$this->w,$this->x,'S','L',1,'siddhanta',10,'','','','B');
        $this->setfieldwidth(25);
        $this->textbox($this->summary['HRTONNAGE']+$this->summary['HRTRTONNAGE'],$this->w,$this->x,'N','R',1,'SakalMarathiNormal922',10,'','','','');
        $this->setfieldwidth(25);
        $this->textbox($this->summary['TRTONNAGE']+$this->summary['HRTRTONNAGE'],$this->w,$this->x,'N','R',1,'SakalMarathiNormal922',10,'','','','');
