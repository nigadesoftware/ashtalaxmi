...
class pumpdiesel extends reportbox
{
    public $fromdate;
    public $todate;
    public $pumpcode;
	...
	function pageheader()
    {
        ...
        $this->textbox('पंपनिहाय डिझेल',180,10,'S','C',1,'siddhanta',12);
        $this->newrow(7);
        ...
        //$this->textbox('स्लिप नं ',$this->w,$this->x,'S','R',1,'siddhanta',11);
        $this->setfieldwidth(15);
        $this->textbox('खरेदी दर',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->setfieldwidth(20);
        $this->textbox('ख.रक्कम',$this->w,$this->x,'S','L',1,'siddhanta',11);
        $this->setfieldwidth(20);
    ...
    function detail_1(&$group_row_1)
    {
        ...
        //$this->setfieldwidth(20);
        //$this->textbox($group_row_1['SLIPNUMBER'],$this->w,$this->x,'N','R',1,'SakalMarathiNormal922',11);
        $this->setfieldwidth(15);
        ...
        $this->setfieldwidth(30);
        $this->textbox($group_row_1['VEHICLENUMBER'],$this->w,$this->x,'N','L',1,'SakalMarathiNormal922',9); 
        $this->setfieldwidth(20);
    ...
    {     
        ...
        $this->textbox($group_row_1['PUMPNAMEUNI'].' एकूण',$this->w,$this->x,'S','R',1,'siddhanta',11,'','','','B');
        $this->setfieldwidth(30);
