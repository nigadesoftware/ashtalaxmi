...
class htrtgs extends reportbox
{
    public $seasoncode;
    ...
    function startreport()
    {
        ...
        $pageheader_query_1="select billperioddescbybillperiodno(2,".$_SESSION['yearperiodcode'].",".$this->billcategorycode.",".$this->billperiodnumber.",1) as desct from dual t";
    ...
    function pageheader()
    {
        ...
        $this->textbox('RTGS HT Saving List',$this->w,$this->x,'S','C',1,'verdana',10,'','','','B');
        $this->newrow();
    ...
    function group()
    {
        ...
        if ($this->flagcode == 1)
        {
            $cond = "h.servicetrhrcategorycode in (1,13)";
        }
        else
        {
    ...
    function export($billperiodtransnumber,$paymentcategorycode)
    {
        ...
        else
        {
           ...
           $response = array();
           if ($paymentcategorycode==1)
           $filename='contractorrtgs_all.csv';
           elseif ($paymentcategorycode==3)
           $filename='contractorrtgs_above2lacbelow5lac.csv';
