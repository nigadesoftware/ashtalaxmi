...
class farmernetpaymentsummary extends reportbox
{
    public $bankcode;
    ...
    function pageheader()
    {
        ...
        $this->textbox('ऊस पेमेंट निव्व्ळ देय समरी',$this->w,$this->x,'S','C',1,'siddhanta',11,'','','','B');
        $this->newrow();
        $this->setfieldwidth(190,10);
        $this->textbox($this->msubtitle,$this->w,$this->x,'S','C',1,'siddhanta',10,'','','','');
        $this->newrow();
        $this->setfieldwidth(195,10);
        $this->textbox('बँक : '.$this->bankname,$this->w,$this->x,'S','L',1,'siddhanta',12,'','','','B');
        $this->newrow();
        ...
        $this->textbox('ब्रांच कोड',$this->w,$this->x,'S','L',1,'siddhanta',11,'','','','B');
        $this->setfieldwidth(80);
        $this->textbox('शाखेचे नाव',$this->w,$this->x,'S','L',1,'siddhanta',11,'','','','B');
        $this->setfieldwidth(30);
        $this->textbox('IFSC',$this->w,$this->x,'S','L',1,'siddhanta',11,'','','','B');
    ...
    function groupheader_1(&$group_row)
    {
        ...
        $this->branchname=$group_row['BANKBRANCHNAMEUNI'];
        $this->newpage(true);
    }
    ...
    function detail_1(&$group_row_1)
    {
        ...
        $this->setfieldwidth(15);
        $this->textbox($group_row_1['BANKBRANCHCODE'],$this->w,$this->x,'N','L',1,'SakalMarathiNormal922',11,'','','','');
        $this->setfieldwidth(80);
        $this->textbox($group_row_1['BANKBRANCHNAMEUNI'],$this->w,$this->x,'S','L',1,'siddhanta',11,'','','','');
        $this->setfieldwidth(30);
        $this->textbox($group_row_1['IFSC'],$this->w,$this->x,'S','L',1,'SakalMarathiNormal922',10,'','','','');
        $this->setfieldwidth(35);
    ...
    {   
       ...
       and t.bankbranchcode=b.bankbranchcode(+)
       and t.billperiodtransnumber=".$this->billperiodtransnumber."
       and b.bankcode=".$last_row['BANKCODE'];
       
       $groupfooter_result_1 = oci_parse($this->connection, $groupfooter_query_2);
       $r = oci_execute($groupfooter_result_1);
       if ($groupfooter_row_1 = oci_fetch_array($groupfooter_result_1,OCI_BOTH+OCI_ASSOC+OCI_RETURN_NULLS))  
       {
           $this->setfieldwidth(20,114);
           $this->textbox('बँक एकूण',$this->w,$this->x,'S','R',1,'siddhanta',11,'','','','B');
           $this->setfieldwidth(47);
           $this->textbox($groupfooter_row_1['NETAMOUNT'],$this->w,$this->x,'N','R',1,'SakalMarathiNormal922',11,'','','','B');
           $this->newrow();
           $this->setfieldwidth(137,10);
           $this->textbox('अक्षरी->',$this->w,$this->x,'S','L',1,'siddhanta',10,'','','','');
           $this->setfieldwidth(112,25);
           $this->textbox(NumberToWords($groupfooter_row_1['NETAMOUNT'],1),$this->w,$this->x,'S','L',1,'siddhanta',10,'','','','');  
