...
class pumpdatesummary extends reportbox
{
	...
	function pageheader()
    {
        ...
        $this->textbox('खरेदी दर',$this->w,$this->x,'S','L',1,'siddhanta',11);
    ...
    function group()
    {
        ...
        {
            $group_query_1 = "
            select t.pumpcode,pumpnameuni,transactiondate
           ...
           and {$cond}))t,pump p
            where t.pumpcode=p.pumpcode
            group by t.pumpcode,pumpnameuni ,transactiondate
            order by t.pumpcode,pumpnameuni,transactiondate
            ";
        }
    ...
    function detail_1(&$group_row_1)
    {
        ...
        $this->setfieldwidth(20);
        $this->textbox($group_row_1['PURCHASERATE'],$this->w,$this->x,'S','L',1,'SakalMarathiNormal922',11);
        $this->setfieldwidth(35);
