...
class farmerbill extends swappreport
{
    ...
    function group()
    {
        ...
        if ($this->villagecode!='' and $this->villagecode!='0')
        {
            if ($cond=='')
            {
                $cond = " and v.villagecode=".$this->villagecode;
            }
            else
            {
        ...
        if (($this->farmercode=='' or $this->farmercode=='0') and ($this->villagecode=='' or $this->villagecode=='0') and ($this->circlecode=='' or $this->circlecode=='0') )
        {
            $cond = '';
        }
