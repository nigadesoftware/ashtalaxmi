...
class circleplantationsummary extends reportbox
{
    public $circlecode;
    public $fromdate;
    public $todate;
    ...
    function reportheader()
    {
        ...
        $this->textbox('गटनिहाय हंगामवार ऊसनोंद गोषवारा',180,10,'S','C',1,'siddhanta',13);
        $this->newrow(7);
    ...
    function group()
    {
        ...
        if ($this->fromdate!='' and $this->todate!='')
        {
            ...
            ,vvv.circlecode,d.divisionnameuni,vvv.circlenameuni,sum(cnt) as cnt
            ,sum(preseasonal) preseasonal
            ,sum(suru) suru,sum(adsali) adsali,sum(khodwa) khodwa,sum(total) total
            from (
            SELECT v.circlecode,0 as cnt
            ...
            union all
            select t.circlecode,count(*) as cnt 
            ,0 as preseasonal
            ,0 as suru
            ,0 as adsali
            ,0 as khodwa
            ...
            ,0 as total
            from 
            (select vv.circlecode,cc.circlenameuni,pp.farmercode 
            from plantationheader pp,village vv,circle cc
            ...
            group by vv.circlecode,cc.circlenameuni,pp.farmercode)t 
            ...
            group by d.divisioncode,d.divisionnameuni,vvv.circlecode,vvv.circlenameuni
            order by d.divisioncode,vvv.circlecode
            ";
        }
        else
        {
