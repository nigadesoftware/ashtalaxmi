...
{	
    ...
    { 
       ...
       // $this->textbox($this->ftransactionnumber['FARMERCOUNT'],175,10,'S','C',1,'siddhanta',13);
        ...
        $this->newrow(10);
        $this->textbox('स्लिप वाईज रजिस्टर',250,10,'S','C',1,'siddhanta',13);
        $this->newrow(7);
        ...
        $this->vline($this->liney-1,$this->liney+15,$this->x+$this->w);
        ...
        $this->vline($this->liney-8,$this->liney+15,$this->x+$this->w);
        $this->newrow(-7);
    ...
    function detail_1(&$group_row_1)
    {
        ...
        $this->setfieldwidth(35);
        $this->textbox($group_row_1['VHARVESTER'],$this->w,$this->x,'N','L',1,'siddhanta',9);
        $this->newrow();
        $this->textbox($group_row_1['VTRANSPORTER'],$this->w,$this->x,'N','L',1,'siddhanta',9);
        $this->vline($this->liney-1,$this->liney+14,$this->x+$this->w);
        $this->newrow(-7);
