...
protected function checkmindatalength($data,$datalabel,$datalength)
	...
	function textcomboname(&$connection,$table,$datafield,$datafieldvalue,$engfield,$unicodefield,$cond='')
	{
		if ($_SESSION['lng']=="English")
		{ 
			if ($cond=='')
				...
				$query = "select ".$engfield." as displayfield from ".$table." where ".$datafield."=".$datafieldvalue." and ".$cond;
		}
		else
		{
			if ($cond=='')
				...
				$query = "select ".$unicodefield." as displayfield from ".$table." where ".$datafield."=".$datafieldvalue." and ".$cond;
		}
