...
// Extend the TCPDF class to create custom Header and Footer
	class MYPDF extends TCPDF 
    {
		...
		public function Header() {
          ...
          //  $this->multicell(0,15,'    Janardan Swami Nagar, Palase, Tal-Dist-Nasik',0,'C',false,1,0,15,true,0,false,true,10);     $this->multicell(0,15,'     पळसे, ता. जि. नाशिक',0,'C',false,1,0,12,true,0,false,true,10);
		}
