<?php
    ...
    and h.villagecode in (select v.villagecode from slipboycentre t,village v,slipboy s 
    where s.userid=".$_SESSION['usersid']." and t.centrecode=v.centrecode and t.slipboycode=s.slipboycode and t.uptodate is null)
    and (h.seasoncode,h.plotnumber) not in (select t.seasoncode,t.plotnumber 
from todslip t 
where t.isharvestingcompleted=1)
     order by plotnumber";
