...
class goodspurchaser extends swappform
{
    ...
    public function insert()
    {
        ...
        {
            $query = "select nvl(max(purchasercode),0)+1 as purchasercode 
            from goodspurchaser where goodscategorycode=".$this->goodscategorycode;
        ...
        $query = "
            ...
            ,".$this->invl($this->tdsapplicable,true,true)."
            )";
        $result = oci_parse($this->connection, $query);
    ...
    public function fetch()
    {
        ...
        ,location
        ,tdsapplicable
        from nst_nasaka_byproductsale.goodspurchaser p,nst_nasaka_db.state s 
    ...
    {
        $this->dataoperationmode = operationmode::Select;
        $query = "select p.debtorsaccountcode accountcode,p.referencecode as referencecode,purchasernameeng,purchasernameuni
        from vw_byproduct_purchaser p
        where goodscategorycode=".$this->goodscategorycode." and p.purchasercode=".$this->purchasercode;
        $result = oci_parse($this->connection, $query);
        $r = oci_execute($result,OCI_NO_AUTO_COMMIT);
        ...
        if ($row = oci_fetch_array($result,OCI_ASSOC+OCI_RETURN_NULLS))
        {
            ...
            $accountsubledger1->subledgertypecode = 14;
