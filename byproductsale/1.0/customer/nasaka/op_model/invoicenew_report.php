...
{	
    ...
    function detail_1(&$group_row_1)
    {
        ...
        $this->setfieldwidth(25);
        $this->textbox($group_row_1['HSNCODE'],$this->w,$this->x,'S','L',1,'verdana',9);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
        ...
        $this->setfieldwidth(15);
        $this->textbox($group_row_1['UNIT'],$this->w,$this->x,'S','R',1,'verdana',9);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
        ...
        $this->setfieldwidth(65,10);
        $this->vline($this->liney-1,$this->liney+6,$this->x);
        $this->textbox($group_row_1['HSNCODE'],$this->w,$this->x,'S','R',1,'verdana',9);
        $this->vline($this->liney-1,$this->liney+6,$this->x+$this->w);
