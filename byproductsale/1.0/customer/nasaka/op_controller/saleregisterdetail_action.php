<?php
    ...
    require_once('../op_model/saleregisterdetail_report.php');
    ...
    $finishedgoodscode= $_POST["finishedgoods"];
    $connection = swapp_connection();
    $invoice1 = new saleregisterdetail($connection,195);
    ...
    $invoice1->purchasercode= $purchasercode;
    $invoice1->finishedgoodscode =$finishedgoodscode;
